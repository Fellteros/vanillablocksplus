...
public class ModBlocks {
    ...
    public static final Block BAMBOO_BLOCK_STAIRS = registerBlock("bamboo_block_stairs",
            new StairsBlock(Blocks.OAK_WOOD.getDefaultState(), FabricBlockSettings.create().instrument(NoteBlockInstrument.BASS).strength(2.0f).sounds(BlockSoundGroup.BAMBOO_WOOD).burnable()));
    public static final Block BAMBOO_BLOCK_SLAB = registerBlock("bamboo_block_slab",
            new SlabBlock(FabricBlockSettings.create().instrument(NoteBlockInstrument.BASS).strength(2.0f).sounds(BlockSoundGroup.BAMBOO_WOOD).burnable()));
    public static final Block BAMBOO_BLOCK_BUTTON = registerBlock("bamboo_block_button",
            new ButtonBlock(FabricBlockSettings.create().instrument(NoteBlockInstrument.BASS).strength(2.0f).sounds(BlockSoundGroup.BAMBOO_WOOD).burnable(), ModBlockSetType.BAMBOO_WOOD, 10, true));
    public static final Block BAMBOO_BLOCK_PRESSURE_PLATE = registerBlock("bamboo_block_pressure_plate",
            new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING,
                    FabricBlockSettings.create().instrument(NoteBlockInstrument.BASS).strength(2.0f).sounds(BlockSoundGroup.BAMBOO_WOOD).burnable(), ModBlockSetType.BAMBOO_WOOD));
    public static final Block BAMBOO_BLOCK_FENCE = registerBlock("bamboo_block_fence",
            new FenceBlock(FabricBlockSettings.create().instrument(NoteBlockInstrument.BASS).strength(2.0f).sounds(BlockSoundGroup.BAMBOO_WOOD).burnable()));
    public static final Block BAMBOO_BLOCK_FENCE_GATE = registerBlock("bamboo_block_fence_gate",
            new FenceGateBlock(FabricBlockSettings.create().instrument(NoteBlockInstrument.BASS).strength(2.0f).sounds(BlockSoundGroup.BAMBOO_WOOD).burnable(), ModWoodType.BAMBOO_WOOD));
    public static final Block BAMBOO_BLOCK_DOOR = registerBlock("bamboo_block_door",
            new DoorBlock(FabricBlockSettings.create().instrument(NoteBlockInstrument.BASS).strength(2.0f).sounds(BlockSoundGroup.BAMBOO_WOOD).burnable(), ModBlockSetType.BAMBOO_WOOD));
    public static final Block BAMBOO_BLOCK_TRAPDOOR = registerBlock("bamboo_block_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.create().instrument(NoteBlockInstrument.BASS).strength(2.0f).sounds(BlockSoundGroup.BAMBOO_WOOD).burnable(), ModBlockSetType.BAMBOO_WOOD));

    //str bamboo wood set
    public static final Block STR_BAMBOO_BLOCK_STAIRS = registerBlock("str_bamboo_block_stairs",
            new StairsBlock(Blocks.STRIPPED_OAK_WOOD.getDefaultState(), FabricBlockSettings.create().strength(2.0f).instrument(NoteBlockInstrument.BASS).sounds(BlockSoundGroup.BAMBOO_WOOD)));
    public static final Block STR_BAMBOO_BLOCK_SLAB = registerBlock("str_bamboo_block_slab",
            new SlabBlock(FabricBlockSettings.create().strength(2.0f).instrument(NoteBlockInstrument.BASS).sounds(BlockSoundGroup.BAMBOO_WOOD)));
    public static final Block STR_BAMBOO_BLOCK_BUTTON = registerBlock("str_bamboo_block_button",
            new ButtonBlock(FabricBlockSettings.create().strength(2.0f).instrument(NoteBlockInstrument.BASS).sounds(BlockSoundGroup.BAMBOO_WOOD), ModBlockSetType.BAMBOO_WOOD, 10, true));
    public static final Block STR_BAMBOO_BLOCK_PRESSURE_PLATE = registerBlock("str_bamboo_block_pressure_plate",
            new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING,
                    FabricBlockSettings.create().strength(2.0f).instrument(NoteBlockInstrument.BASS).sounds(BlockSoundGroup.BAMBOO_WOOD), ModBlockSetType.BAMBOO_WOOD));
    public static final Block STR_BAMBOO_BLOCK_FENCE = registerBlock("str_bamboo_block_fence",
            new FenceBlock(FabricBlockSettings.create().strength(2.0f).instrument(NoteBlockInstrument.BASS).sounds(BlockSoundGroup.BAMBOO_WOOD)));
    public static final Block STR_BAMBOO_BLOCK_FENCE_GATE = registerBlock("str_bamboo_block_fence_gate",
            new FenceGateBlock(FabricBlockSettings.create().strength(2.0f).instrument(NoteBlockInstrument.BASS).sounds(BlockSoundGroup.BAMBOO_WOOD), ModWoodType.BAMBOO_WOOD));
    public static final Block STR_BAMBOO_BLOCK_DOOR = registerBlock("str_bamboo_block_door",
            new DoorBlock(FabricBlockSettings.create().strength(2.0f).instrument(NoteBlockInstrument.BASS).sounds(BlockSoundGroup.BAMBOO_WOOD), ModBlockSetType.BAMBOO_WOOD));
    public static final Block STR_BAMBOO_BLOCK_TRAPDOOR = registerBlock("str_bamboo_block_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.create().strength(2.0f).instrument(NoteBlockInstrument.BASS).sounds(BlockSoundGroup.BAMBOO_WOOD), ModBlockSetType.BAMBOO_WOOD));
    ...
    public static final Block REDSTONE_ORE_WALL = registerBlock("redstone_ore_wall",
            new WallBlock(FabricBlockSettings.create().instrument(NoteBlockInstrument.BASEDRUM).requiresTool().ticksRandomly().strength(3.0f, 3.0f)));
