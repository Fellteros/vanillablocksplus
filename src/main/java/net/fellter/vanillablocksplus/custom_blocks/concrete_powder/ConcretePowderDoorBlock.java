...
public class ConcretePowderDoorBlock extends DoorBlock implements LandingBlock {
    private final BlockState hardenedState;

    public ConcretePowderDoorBlock(Settings settings, BlockSetType blockSetType, Block hardened) {
        ...
        if (shouldHarden(blockView, blockPos, blockView.getBlockState(blockPos))) {
            if (placementState != null) {
                return this.hardenedState
                        ...
                        .with(HINGE, placementState.get(HINGE))
    ...
    public BlockState getStateForNeighborUpdate(BlockState state, Direction direction, BlockState neighborState, WorldAccess world, BlockPos pos, BlockPos neighborPos) {
        if (hardensOnAnySide(world, pos)) {
            return this.hardenedState
                    ...
                    .with(HINGE, world.getBlockState(pos).get(HINGE))
