...
public class ConcretePowderPressurePlateBlock extends PressurePlateBlock {
    private final BlockState hardenedState;

    public ConcretePowderPressurePlateBlock(ActivationRule type, Settings settings, BlockSetType blockSetType, Block hardened) {
