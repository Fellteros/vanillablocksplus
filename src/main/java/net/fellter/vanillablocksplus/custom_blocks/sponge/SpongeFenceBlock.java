...
public class SpongeFenceBlock extends FenceBlock {
    private static final Direction[] field_43257 = Direction.values();

    public SpongeFenceBlock(Settings settings) {
        super(settings);
    }
    ...
    protected void update(World world, BlockPos pos) {
        if (this.absorbWater(world, pos)) {
            world.setBlockState(pos, ModBlocks2.WET_SPONGE_FENCE.getDefaultState()
