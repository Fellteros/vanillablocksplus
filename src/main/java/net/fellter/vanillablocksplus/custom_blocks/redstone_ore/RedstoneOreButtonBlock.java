...
public class RedstoneOreButtonBlock extends ButtonBlock {
    public RedstoneOreButtonBlock(BlockSetType blockSetType, int pressTicks, AbstractBlock.Settings settings) {
