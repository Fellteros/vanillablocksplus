...
public class RedstoneOrePressurePlateBlock extends PressurePlateBlock {
    public RedstoneOrePressurePlateBlock(BlockSetType type, AbstractBlock.Settings settings) {
        super(type, settings);
    }
