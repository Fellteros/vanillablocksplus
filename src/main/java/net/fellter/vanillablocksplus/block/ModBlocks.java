...
public class ModBlocks {
    ...
    public static final Block PALE_OAK_WALL = registerBlock("pale_oak_wall", WallBlock::new, AbstractBlock.Settings.copy(Blocks.PALE_OAK_PLANKS));
    ...
    //RESIN_bricks_set
    public static final Block RESIN_BRICK_BUTTON = registerBlock("resin_brick_button", settings -> new ButtonBlock(ModBlockSetType.RESIN, 10, settings), AbstractBlock.Settings.copy(Blocks.RESIN_BRICKS));
    public static final Block RESIN_BRICK_PRESSURE_PLATE = registerBlock("resin_brick_pressure_plate", settings -> new PressurePlateBlock(ModBlockSetType.RESIN_BRICKS, settings), AbstractBlock.Settings.copy(Blocks.RESIN_BRICKS));
    public static final Block RESIN_BRICK_FENCE = registerBlock("resin_brick_fence", FenceBlock::new, AbstractBlock.Settings.copy(Blocks.RESIN_BRICKS));
    public static final Block RESIN_BRICK_FENCE_GATE = registerBlock("resin_brick_fence_gate", settings -> new FenceGateBlock(ModWoodType.RESIN_BRICKS, settings), AbstractBlock.Settings.copy(Blocks.RESIN_BRICKS));
    public static final Block RESIN_BRICK_DOOR = registerBlock("resin_brick_door", settings -> new DoorBlock(ModBlockSetType.RESIN_BRICKS, settings), AbstractBlock.Settings.copy(Blocks.RESIN_BRICKS));
    public static final Block RESIN_BRICK_TRAPDOOR = registerBlock("resin_brick_trapdoor", settings -> new TrapdoorBlock(ModBlockSetType.RESIN_BRICKS, settings), AbstractBlock.Settings.copy(Blocks.RESIN_BRICKS));

    //chiseled_resin_brick_set
    public static final Block CHISELED_RESIN_BRICK_STAIRS = registerBlock("chiseled_resin_brick_stairs", settings -> new StairsBlock(Blocks.CHISELED_RESIN_BRICKS.getDefaultState(), settings), AbstractBlock.Settings.copy(Blocks.CHISELED_RESIN_BRICKS));
    public static final Block CHISELED_RESIN_BRICK_SLAB = registerBlock("chiseled_resin_brick_slab", SlabBlock::new, AbstractBlock.Settings.copy(Blocks.CHISELED_RESIN_BRICKS));
    public static final Block CHISELED_RESIN_BRICK_BUTTON = registerBlock("chiseled_resin_brick_button", settings -> new ButtonBlock(ModBlockSetType.RESIN_BRICKS, 10, settings), AbstractBlock.Settings.copy(Blocks.CHISELED_RESIN_BRICKS));
    public static final Block CHISELED_RESIN_BRICK_PRESSURE_PLATE = registerBlock("chiseled_resin_brick_pressure_plate", settings -> new PressurePlateBlock(ModBlockSetType.RESIN_BRICKS, settings), AbstractBlock.Settings.copy(Blocks.CHISELED_RESIN_BRICKS));
    public static final Block CHISELED_RESIN_BRICK_FENCE = registerBlock("chiseled_resin_brick_fence", FenceBlock::new, AbstractBlock.Settings.copy(Blocks.CHISELED_RESIN_BRICKS));
    public static final Block CHISELED_RESIN_BRICK_FENCE_GATE = registerBlock("chiseled_resin_brick_fence_gate", settings -> new FenceGateBlock(ModWoodType.RESIN_BRICKS, settings), AbstractBlock.Settings.copy(Blocks.CHISELED_RESIN_BRICKS));
    public static final Block CHISELED_RESIN_BRICK_DOOR = registerBlock("chiseled_resin_brick_door", settings -> new DoorBlock(ModBlockSetType.RESIN_BRICKS, settings), AbstractBlock.Settings.copy(Blocks.CHISELED_RESIN_BRICKS));
    public static final Block CHISELED_RESIN_BRICK_TRAPDOOR = registerBlock("chiseled_resin_brick_trapdoor", settings -> new TrapdoorBlock(ModBlockSetType.RESIN_BRICKS, settings), AbstractBlock.Settings.copy(Blocks.CHISELED_RESIN_BRICKS));
    public static final Block CHISELED_RESIN_BRICK_WALL = registerBlock("chiseled_resin_brick_wall", WallBlock::new, AbstractBlock.Settings.copy(Blocks.CHISELED_RESIN_BRICKS));
