...
public class ModItemGroups {
    ...
    public static final ItemGroup VBP_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().displayName(Text.translatable("itemgroup.vanillablocksplus"))
                    .icon(() -> new ItemStack(ModItems.VBP_TITLE)).entries((displayContext, entries) -> {
                        ...
                        entries.add(ModBlocks.STR_OAK_WOOD_WALL);
                        ...
                        entries.add(ModBlocks.STR_SPRUCE_WOOD_WALL);
                        ...
                        entries.add(ModBlocks.STR_BIRCH_WOOD_WALL);
                        ...
                        entries.add(ModBlocks.STR_JUNGLE_WOOD_WALL);
                        ...
                        entries.add(ModBlocks.STR_ACACIA_WOOD_WALL);
                        ...
                        entries.add(ModBlocks.STR_DARK_OAK_WOOD_WALL);
                        ...
                        entries.add(ModBlocks.STR_MANGROVE_WOOD_WALL);
                        ...
                        entries.add(ModBlocks.STR_CHERRY_WOOD_WALL);
                        ...
                        entries.add(ModBlocks.BAMBOO_BLOCK_WALL);
                        ...
                        entries.add(ModBlocks.STR_BAMBOO_BLOCK_WALL);
                        ...
                        entries.add(ModBlocks.STR_WARPED_HYPHAE_WALL);
                        ...
                        //chiseled_copper
                        entries.add(ModBlocks2.CHISELED_COPPER_STAIRS);
                        entries.add(ModBlocks2.CHISELED_COPPER_SLAB);
                        entries.add(ModBlocks2.CHISELED_COPPER_WALL);
                        entries.add(ModBlocks2.CHISELED_COPPER_FENCE);
                        entries.add(ModBlocks2.CHISELED_COPPER_FENCE_GATE);
                        entries.add(ModBlocks2.CHISELED_COPPER_DOOR);
                        entries.add(ModBlocks2.CHISELED_COPPER_TRAPDOOR);
                        entries.add(ModBlocks2.CHISELED_COPPER_PRESSURE_PLATE);
                        entries.add(ModBlocks2.CHISELED_COPPER_BUTTON);
                        //copper_grate
                        entries.add(ModBlocks2.COPPER_GRATE_STAIRS);
                        entries.add(ModBlocks2.COPPER_GRATE_SLAB);
                        entries.add(ModBlocks2.COPPER_GRATE_WALL);
                        entries.add(ModBlocks2.COPPER_GRATE_FENCE);
                        entries.add(ModBlocks2.COPPER_GRATE_FENCE_GATE);
                        entries.add(ModBlocks2.COPPER_GRATE_DOOR);
                        entries.add(ModBlocks2.COPPER_GRATE_TRAPDOOR);
                        entries.add(ModBlocks2.COPPER_GRATE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.COPPER_GRATE_BUTTON);
                        //cut_copper
                        ...
                        entries.add(ModBlocks2.EXPOSED_CHISELED_COPPER_STAIRS);
                        entries.add(ModBlocks2.EXPOSED_CHISELED_COPPER_SLAB);
                        entries.add(ModBlocks2.EXPOSED_CHISELED_COPPER_WALL);
                        entries.add(ModBlocks2.EXPOSED_CHISELED_COPPER_FENCE);
                        entries.add(ModBlocks2.EXPOSED_CHISELED_COPPER_FENCE_GATE);
                        entries.add(ModBlocks2.EXPOSED_CHISELED_COPPER_DOOR);
                        entries.add(ModBlocks2.EXPOSED_CHISELED_COPPER_TRAPDOOR);
                        entries.add(ModBlocks2.EXPOSED_CHISELED_COPPER_PRESSURE_PLATE);
                        entries.add(ModBlocks2.EXPOSED_CHISELED_COPPER_BUTTON);
                        //exposed_copper_grate
                        entries.add(ModBlocks2.EXPOSED_COPPER_GRATE_STAIRS);
                        entries.add(ModBlocks2.EXPOSED_COPPER_GRATE_SLAB);
                        entries.add(ModBlocks2.EXPOSED_COPPER_GRATE_WALL);
                        entries.add(ModBlocks2.EXPOSED_COPPER_GRATE_FENCE);
                        entries.add(ModBlocks2.EXPOSED_COPPER_GRATE_FENCE_GATE);
                        entries.add(ModBlocks2.EXPOSED_COPPER_GRATE_DOOR);
                        entries.add(ModBlocks2.EXPOSED_COPPER_GRATE_TRAPDOOR);
                        entries.add(ModBlocks2.EXPOSED_COPPER_GRATE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.EXPOSED_COPPER_GRATE_BUTTON);
                        //exposed_cut_copper
                        ...
                        entries.add(ModBlocks2.WEATHERED_CHISELED_COPPER_STAIRS);
                        entries.add(ModBlocks2.WEATHERED_CHISELED_COPPER_SLAB);
                        entries.add(ModBlocks2.WEATHERED_CHISELED_COPPER_WALL);
                        entries.add(ModBlocks2.WEATHERED_CHISELED_COPPER_FENCE);
                        entries.add(ModBlocks2.WEATHERED_CHISELED_COPPER_FENCE_GATE);
                        entries.add(ModBlocks2.WEATHERED_CHISELED_COPPER_DOOR);
                        entries.add(ModBlocks2.WEATHERED_CHISELED_COPPER_TRAPDOOR);
                        entries.add(ModBlocks2.WEATHERED_CHISELED_COPPER_PRESSURE_PLATE);
                        entries.add(ModBlocks2.WEATHERED_CHISELED_COPPER_BUTTON);
                        //weathered_copper_grate
                        entries.add(ModBlocks2.WEATHERED_COPPER_GRATE_STAIRS);
                        entries.add(ModBlocks2.WEATHERED_COPPER_GRATE_SLAB);
                        entries.add(ModBlocks2.WEATHERED_COPPER_GRATE_WALL);
                        entries.add(ModBlocks2.WEATHERED_COPPER_GRATE_FENCE);
                        entries.add(ModBlocks2.WEATHERED_COPPER_GRATE_FENCE_GATE);
                        entries.add(ModBlocks2.WEATHERED_COPPER_GRATE_DOOR);
                        entries.add(ModBlocks2.WEATHERED_COPPER_GRATE_TRAPDOOR);
                        entries.add(ModBlocks2.WEATHERED_COPPER_GRATE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.WEATHERED_COPPER_GRATE_BUTTON);
                        ...
                        entries.add(ModBlocks2.OXIDIZED_CHISELED_COPPER_STAIRS);
                        entries.add(ModBlocks2.OXIDIZED_CHISELED_COPPER_SLAB);
                        entries.add(ModBlocks2.OXIDIZED_CHISELED_COPPER_WALL);
                        entries.add(ModBlocks2.OXIDIZED_CHISELED_COPPER_FENCE);
                        entries.add(ModBlocks2.OXIDIZED_CHISELED_COPPER_FENCE_GATE);
                        entries.add(ModBlocks2.OXIDIZED_CHISELED_COPPER_DOOR);
                        entries.add(ModBlocks2.OXIDIZED_CHISELED_COPPER_TRAPDOOR);
                        entries.add(ModBlocks2.OXIDIZED_CHISELED_COPPER_PRESSURE_PLATE);
                        entries.add(ModBlocks2.OXIDIZED_CHISELED_COPPER_BUTTON);
                        //oxidized_copper_grate
                        entries.add(ModBlocks2.OXIDIZED_COPPER_GRATE_STAIRS);
                        entries.add(ModBlocks2.OXIDIZED_COPPER_GRATE_SLAB);
                        entries.add(ModBlocks2.OXIDIZED_COPPER_GRATE_WALL);
                        entries.add(ModBlocks2.OXIDIZED_COPPER_GRATE_FENCE);
                        entries.add(ModBlocks2.OXIDIZED_COPPER_GRATE_FENCE_GATE);
                        entries.add(ModBlocks2.OXIDIZED_COPPER_GRATE_DOOR);
                        entries.add(ModBlocks2.OXIDIZED_COPPER_GRATE_TRAPDOOR);
                        entries.add(ModBlocks2.OXIDIZED_COPPER_GRATE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.OXIDIZED_COPPER_GRATE_BUTTON);
                        //oxidized_cut_copper
                        ...
                        //waxed_copper
                        entries.add(ModBlocks2.WAXED_CHISELED_COPPER_STAIRS);
                        entries.add(ModBlocks2.WAXED_CHISELED_COPPER_SLAB);
                        entries.add(ModBlocks2.WAXED_CHISELED_COPPER_WALL);
                        entries.add(ModBlocks2.WAXED_CHISELED_COPPER_FENCE);
                        entries.add(ModBlocks2.WAXED_CHISELED_COPPER_FENCE_GATE);
                        entries.add(ModBlocks2.WAXED_CHISELED_COPPER_DOOR);
                        entries.add(ModBlocks2.WAXED_CHISELED_COPPER_TRAPDOOR);
                        entries.add(ModBlocks2.WAXED_CHISELED_COPPER_PRESSURE_PLATE);
                        entries.add(ModBlocks2.WAXED_CHISELED_COPPER_BUTTON);
                        //waxed_copper
                        entries.add(ModBlocks2.WAXED_COPPER_GRATE_STAIRS);
                        entries.add(ModBlocks2.WAXED_COPPER_GRATE_SLAB);
                        entries.add(ModBlocks2.WAXED_COPPER_GRATE_WALL);
                        entries.add(ModBlocks2.WAXED_COPPER_GRATE_FENCE);
                        entries.add(ModBlocks2.WAXED_COPPER_GRATE_FENCE_GATE);
                        entries.add(ModBlocks2.WAXED_COPPER_GRATE_DOOR);
                        entries.add(ModBlocks2.WAXED_COPPER_GRATE_TRAPDOOR);
                        entries.add(ModBlocks2.WAXED_COPPER_GRATE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.WAXED_COPPER_GRATE_BUTTON);
                        //waxed_cut copper
                        ...
                        //waxed_copper
                        entries.add(ModBlocks2.WAXED_EXPOSED_CHISELED_COPPER_STAIRS);
                        entries.add(ModBlocks2.WAXED_EXPOSED_CHISELED_COPPER_SLAB);
                        entries.add(ModBlocks2.WAXED_EXPOSED_CHISELED_COPPER_WALL);
                        entries.add(ModBlocks2.WAXED_EXPOSED_CHISELED_COPPER_FENCE);
                        entries.add(ModBlocks2.WAXED_EXPOSED_CHISELED_COPPER_FENCE_GATE);
                        entries.add(ModBlocks2.WAXED_EXPOSED_CHISELED_COPPER_DOOR);
                        entries.add(ModBlocks2.WAXED_EXPOSED_CHISELED_COPPER_TRAPDOOR);
                        entries.add(ModBlocks2.WAXED_EXPOSED_CHISELED_COPPER_PRESSURE_PLATE);
                        entries.add(ModBlocks2.WAXED_EXPOSED_CHISELED_COPPER_BUTTON);
                        //waxed_copper
                        entries.add(ModBlocks2.WAXED_EXPOSED_COPPER_GRATE_STAIRS);
                        entries.add(ModBlocks2.WAXED_EXPOSED_COPPER_GRATE_SLAB);
                        entries.add(ModBlocks2.WAXED_EXPOSED_COPPER_GRATE_WALL);
                        entries.add(ModBlocks2.WAXED_EXPOSED_COPPER_GRATE_FENCE);
                        entries.add(ModBlocks2.WAXED_EXPOSED_COPPER_GRATE_FENCE_GATE);
                        entries.add(ModBlocks2.WAXED_EXPOSED_COPPER_GRATE_DOOR);
                        entries.add(ModBlocks2.WAXED_EXPOSED_COPPER_GRATE_TRAPDOOR);
                        entries.add(ModBlocks2.WAXED_EXPOSED_COPPER_GRATE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.WAXED_EXPOSED_COPPER_GRATE_BUTTON);
                        ...
                        //waxed_copper
                        entries.add(ModBlocks2.WAXED_WEATHERED_CHISELED_COPPER_STAIRS);
                        entries.add(ModBlocks2.WAXED_WEATHERED_CHISELED_COPPER_SLAB);
                        entries.add(ModBlocks2.WAXED_WEATHERED_CHISELED_COPPER_WALL);
                        entries.add(ModBlocks2.WAXED_WEATHERED_CHISELED_COPPER_FENCE);
                        entries.add(ModBlocks2.WAXED_WEATHERED_CHISELED_COPPER_FENCE_GATE);
                        entries.add(ModBlocks2.WAXED_WEATHERED_CHISELED_COPPER_DOOR);
                        entries.add(ModBlocks2.WAXED_WEATHERED_CHISELED_COPPER_TRAPDOOR);
                        entries.add(ModBlocks2.WAXED_WEATHERED_CHISELED_COPPER_PRESSURE_PLATE);
                        entries.add(ModBlocks2.WAXED_WEATHERED_CHISELED_COPPER_BUTTON);
                        //waxed_copper
                        entries.add(ModBlocks2.WAXED_WEATHERED_COPPER_GRATE_STAIRS);
                        entries.add(ModBlocks2.WAXED_WEATHERED_COPPER_GRATE_SLAB);
                        entries.add(ModBlocks2.WAXED_WEATHERED_COPPER_GRATE_WALL);
                        entries.add(ModBlocks2.WAXED_WEATHERED_COPPER_GRATE_FENCE);
                        entries.add(ModBlocks2.WAXED_WEATHERED_COPPER_GRATE_FENCE_GATE);
                        entries.add(ModBlocks2.WAXED_WEATHERED_COPPER_GRATE_DOOR);
                        entries.add(ModBlocks2.WAXED_WEATHERED_COPPER_GRATE_TRAPDOOR);
                        entries.add(ModBlocks2.WAXED_WEATHERED_COPPER_GRATE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.WAXED_WEATHERED_COPPER_GRATE_BUTTON);
                        ...
                        //waxed_copper
                        entries.add(ModBlocks2.WAXED_OXIDIZED_CHISELED_COPPER_STAIRS);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_CHISELED_COPPER_SLAB);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_CHISELED_COPPER_WALL);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_CHISELED_COPPER_FENCE);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_CHISELED_COPPER_FENCE_GATE);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_CHISELED_COPPER_DOOR);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_CHISELED_COPPER_TRAPDOOR);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_CHISELED_COPPER_PRESSURE_PLATE);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_CHISELED_COPPER_BUTTON);
                        //waxed_copper
                        entries.add(ModBlocks2.WAXED_OXIDIZED_COPPER_GRATE_STAIRS);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_COPPER_GRATE_SLAB);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_COPPER_GRATE_WALL);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_COPPER_GRATE_FENCE);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_COPPER_GRATE_FENCE_GATE);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_COPPER_GRATE_DOOR);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_COPPER_GRATE_TRAPDOOR);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_COPPER_GRATE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.WAXED_OXIDIZED_COPPER_GRATE_BUTTON);
                        ...
                        //coal_ore
                        entries.add(ModBlocks2.COAL_ORE_STAIRS);
                        entries.add(ModBlocks2.COAL_ORE_SLAB);
                        entries.add(ModBlocks2.COAL_ORE_WALL);
                        entries.add(ModBlocks2.COAL_ORE_FENCE);
                        entries.add(ModBlocks2.COAL_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.COAL_ORE_DOOR);
                        entries.add(ModBlocks2.COAL_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.COAL_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.COAL_ORE_BUTTON);
                        //deepslate_coal_ore
                        entries.add(ModBlocks2.DEEPSLATE_COAL_ORE_STAIRS);
                        entries.add(ModBlocks2.DEEPSLATE_COAL_ORE_SLAB);
                        entries.add(ModBlocks2.DEEPSLATE_COAL_ORE_WALL);
                        entries.add(ModBlocks2.DEEPSLATE_COAL_ORE_FENCE);
                        entries.add(ModBlocks2.DEEPSLATE_COAL_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.DEEPSLATE_COAL_ORE_DOOR);
                        entries.add(ModBlocks2.DEEPSLATE_COAL_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.DEEPSLATE_COAL_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DEEPSLATE_COAL_ORE_BUTTON);
                        //iron_ore
                        entries.add(ModBlocks2.IRON_ORE_STAIRS);
                        entries.add(ModBlocks2.IRON_ORE_SLAB);
                        entries.add(ModBlocks2.IRON_ORE_WALL);
                        entries.add(ModBlocks2.IRON_ORE_FENCE);
                        entries.add(ModBlocks2.IRON_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.IRON_ORE_DOOR);
                        entries.add(ModBlocks2.IRON_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.IRON_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.IRON_ORE_BUTTON);
                        //deepslate_iron_ore
                        entries.add(ModBlocks2.DEEPSLATE_IRON_ORE_STAIRS);
                        entries.add(ModBlocks2.DEEPSLATE_IRON_ORE_SLAB);
                        entries.add(ModBlocks2.DEEPSLATE_IRON_ORE_WALL);
                        entries.add(ModBlocks2.DEEPSLATE_IRON_ORE_FENCE);
                        entries.add(ModBlocks2.DEEPSLATE_IRON_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.DEEPSLATE_IRON_ORE_DOOR);
                        entries.add(ModBlocks2.DEEPSLATE_IRON_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.DEEPSLATE_IRON_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DEEPSLATE_IRON_ORE_BUTTON);
                        //copper_ore
                        entries.add(ModBlocks2.COPPER_ORE_STAIRS);
                        entries.add(ModBlocks2.COPPER_ORE_SLAB);
                        entries.add(ModBlocks2.COPPER_ORE_WALL);
                        entries.add(ModBlocks2.COPPER_ORE_FENCE);
                        entries.add(ModBlocks2.COPPER_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.COPPER_ORE_DOOR);
                        entries.add(ModBlocks2.COPPER_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.COPPER_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.COPPER_ORE_BUTTON);
                        //deepslate_copper_ore
                        entries.add(ModBlocks2.DEEPSLATE_COPPER_ORE_STAIRS);
                        entries.add(ModBlocks2.DEEPSLATE_COPPER_ORE_SLAB);
                        entries.add(ModBlocks2.DEEPSLATE_COPPER_ORE_WALL);
                        entries.add(ModBlocks2.DEEPSLATE_COPPER_ORE_FENCE);
                        entries.add(ModBlocks2.DEEPSLATE_COPPER_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.DEEPSLATE_COPPER_ORE_DOOR);
                        entries.add(ModBlocks2.DEEPSLATE_COPPER_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.DEEPSLATE_COPPER_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DEEPSLATE_COPPER_ORE_BUTTON);
                        //gold_ore
                        entries.add(ModBlocks2.GOLD_ORE_STAIRS);
                        entries.add(ModBlocks2.GOLD_ORE_SLAB);
                        entries.add(ModBlocks2.GOLD_ORE_WALL);
                        entries.add(ModBlocks2.GOLD_ORE_FENCE);
                        entries.add(ModBlocks2.GOLD_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.GOLD_ORE_DOOR);
                        entries.add(ModBlocks2.GOLD_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.GOLD_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.GOLD_ORE_BUTTON);
                        //deepslate_gold_ore
                        entries.add(ModBlocks2.DEEPSLATE_GOLD_ORE_STAIRS);
                        entries.add(ModBlocks2.DEEPSLATE_GOLD_ORE_SLAB);
                        entries.add(ModBlocks2.DEEPSLATE_GOLD_ORE_WALL);
                        entries.add(ModBlocks2.DEEPSLATE_GOLD_ORE_FENCE);
                        entries.add(ModBlocks2.DEEPSLATE_GOLD_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.DEEPSLATE_GOLD_ORE_DOOR);
                        entries.add(ModBlocks2.DEEPSLATE_GOLD_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.DEEPSLATE_GOLD_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DEEPSLATE_GOLD_ORE_BUTTON);
                        //redstone_ore
                        entries.add(ModBlocks2.REDSTONE_ORE_STAIRS);
                        entries.add(ModBlocks2.REDSTONE_ORE_SLAB);
                        entries.add(ModBlocks2.REDSTONE_ORE_WALL);
                        entries.add(ModBlocks2.REDSTONE_ORE_FENCE);
                        entries.add(ModBlocks2.REDSTONE_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.REDSTONE_ORE_DOOR);
                        entries.add(ModBlocks2.REDSTONE_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.REDSTONE_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.REDSTONE_ORE_BUTTON);
                        //deepslate_redstone_ore
                        entries.add(ModBlocks2.DEEPSLATE_REDSTONE_ORE_STAIRS);
                        entries.add(ModBlocks2.DEEPSLATE_REDSTONE_ORE_SLAB);
                        entries.add(ModBlocks2.DEEPSLATE_REDSTONE_ORE_WALL);
                        entries.add(ModBlocks2.DEEPSLATE_REDSTONE_ORE_FENCE);
                        entries.add(ModBlocks2.DEEPSLATE_REDSTONE_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.DEEPSLATE_REDSTONE_ORE_DOOR);
                        entries.add(ModBlocks2.DEEPSLATE_REDSTONE_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.DEEPSLATE_REDSTONE_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DEEPSLATE_REDSTONE_ORE_BUTTON);
                        //emerald_ore
                        entries.add(ModBlocks2.EMERALD_ORE_STAIRS);
                        entries.add(ModBlocks2.EMERALD_ORE_SLAB);
                        entries.add(ModBlocks2.EMERALD_ORE_WALL);
                        entries.add(ModBlocks2.EMERALD_ORE_FENCE);
                        entries.add(ModBlocks2.EMERALD_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.EMERALD_ORE_DOOR);
                        entries.add(ModBlocks2.EMERALD_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.EMERALD_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.EMERALD_ORE_BUTTON);
                        //deepslate_emerald_ore
                        entries.add(ModBlocks2.DEEPSLATE_EMERALD_ORE_STAIRS);
                        entries.add(ModBlocks2.DEEPSLATE_EMERALD_ORE_SLAB);
                        entries.add(ModBlocks2.DEEPSLATE_EMERALD_ORE_WALL);
                        entries.add(ModBlocks2.DEEPSLATE_EMERALD_ORE_FENCE);
                        entries.add(ModBlocks2.DEEPSLATE_EMERALD_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.DEEPSLATE_EMERALD_ORE_DOOR);
                        entries.add(ModBlocks2.DEEPSLATE_EMERALD_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.DEEPSLATE_EMERALD_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DEEPSLATE_EMERALD_ORE_BUTTON);
                        //lapis_ore
                        entries.add(ModBlocks2.LAPIS_ORE_STAIRS);
                        entries.add(ModBlocks2.LAPIS_ORE_SLAB);
                        entries.add(ModBlocks2.LAPIS_ORE_WALL);
                        entries.add(ModBlocks2.LAPIS_ORE_FENCE);
                        entries.add(ModBlocks2.LAPIS_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.LAPIS_ORE_DOOR);
                        entries.add(ModBlocks2.LAPIS_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.LAPIS_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.LAPIS_ORE_BUTTON);
                        //deepslate_lapis_ore
                        entries.add(ModBlocks2.DEEPSLATE_LAPIS_ORE_STAIRS);
                        entries.add(ModBlocks2.DEEPSLATE_LAPIS_ORE_SLAB);
                        entries.add(ModBlocks2.DEEPSLATE_LAPIS_ORE_WALL);
                        entries.add(ModBlocks2.DEEPSLATE_LAPIS_ORE_FENCE);
                        entries.add(ModBlocks2.DEEPSLATE_LAPIS_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.DEEPSLATE_LAPIS_ORE_DOOR);
                        entries.add(ModBlocks2.DEEPSLATE_LAPIS_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.DEEPSLATE_LAPIS_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DEEPSLATE_LAPIS_ORE_BUTTON);
                        //diamond_ore
                        entries.add(ModBlocks2.DIAMOND_ORE_STAIRS);
                        entries.add(ModBlocks2.DIAMOND_ORE_SLAB);
                        entries.add(ModBlocks2.DIAMOND_ORE_WALL);
                        entries.add(ModBlocks2.DIAMOND_ORE_FENCE);
                        entries.add(ModBlocks2.DIAMOND_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.DIAMOND_ORE_DOOR);
                        entries.add(ModBlocks2.DIAMOND_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.DIAMOND_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DIAMOND_ORE_BUTTON);
                        //deepslate_diamond_ore
                        entries.add(ModBlocks2.DEEPSLATE_DIAMOND_ORE_STAIRS);
                        entries.add(ModBlocks2.DEEPSLATE_DIAMOND_ORE_SLAB);
                        entries.add(ModBlocks2.DEEPSLATE_DIAMOND_ORE_WALL);
                        entries.add(ModBlocks2.DEEPSLATE_DIAMOND_ORE_FENCE);
                        entries.add(ModBlocks2.DEEPSLATE_DIAMOND_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.DEEPSLATE_DIAMOND_ORE_DOOR);
                        entries.add(ModBlocks2.DEEPSLATE_DIAMOND_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.DEEPSLATE_DIAMOND_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DEEPSLATE_DIAMOND_ORE_BUTTON);
                        //nether_gold_ore
                        entries.add(ModBlocks2.NETHER_GOLD_ORE_STAIRS);
                        entries.add(ModBlocks2.NETHER_GOLD_ORE_SLAB);
                        entries.add(ModBlocks2.NETHER_GOLD_ORE_WALL);
                        entries.add(ModBlocks2.NETHER_GOLD_ORE_FENCE);
                        entries.add(ModBlocks2.NETHER_GOLD_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.NETHER_GOLD_ORE_DOOR);
                        entries.add(ModBlocks2.NETHER_GOLD_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.NETHER_GOLD_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.NETHER_GOLD_ORE_BUTTON);
                        //nether_quartz_ore
                        entries.add(ModBlocks2.NETHER_QUARTZ_ORE_STAIRS);
                        entries.add(ModBlocks2.NETHER_QUARTZ_ORE_SLAB);
                        entries.add(ModBlocks2.NETHER_QUARTZ_ORE_WALL);
                        entries.add(ModBlocks2.NETHER_QUARTZ_ORE_FENCE);
                        entries.add(ModBlocks2.NETHER_QUARTZ_ORE_FENCE_GATE);
                        entries.add(ModBlocks2.NETHER_QUARTZ_ORE_DOOR);
                        entries.add(ModBlocks2.NETHER_QUARTZ_ORE_TRAPDOOR);
                        entries.add(ModBlocks2.NETHER_QUARTZ_ORE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.NETHER_QUARTZ_ORE_BUTTON);
                        //ancient_debris
                        entries.add(ModBlocks2.ANCIENT_DEBRIS_STAIRS);
                        entries.add(ModBlocks2.ANCIENT_DEBRIS_SLAB);
                        entries.add(ModBlocks2.ANCIENT_DEBRIS_WALL);
                        entries.add(ModBlocks2.ANCIENT_DEBRIS_FENCE);
                        entries.add(ModBlocks2.ANCIENT_DEBRIS_FENCE_GATE);
                        entries.add(ModBlocks2.ANCIENT_DEBRIS_DOOR);
                        entries.add(ModBlocks2.ANCIENT_DEBRIS_TRAPDOOR);
                        entries.add(ModBlocks2.ANCIENT_DEBRIS_PRESSURE_PLATE);
                        entries.add(ModBlocks2.ANCIENT_DEBRIS_BUTTON);
                        //raw_iron_block
                        entries.add(ModBlocks2.RAW_IRON_STAIRS);
                        entries.add(ModBlocks2.RAW_IRON_SLAB);
                        entries.add(ModBlocks2.RAW_IRON_WALL);
                        entries.add(ModBlocks2.RAW_IRON_FENCE);
                        entries.add(ModBlocks2.RAW_IRON_FENCE_GATE);
                        entries.add(ModBlocks2.RAW_IRON_DOOR);
                        entries.add(ModBlocks2.RAW_IRON_TRAPDOOR);
                        entries.add(ModBlocks2.RAW_IRON_PRESSURE_PLATE);
                        entries.add(ModBlocks2.RAW_IRON_BUTTON);
                        //raw_copper_block
                        entries.add(ModBlocks2.RAW_COPPER_STAIRS);
                        entries.add(ModBlocks2.RAW_COPPER_SLAB);
                        entries.add(ModBlocks2.RAW_COPPER_WALL);
                        entries.add(ModBlocks2.RAW_COPPER_FENCE);
                        entries.add(ModBlocks2.RAW_COPPER_FENCE_GATE);
                        entries.add(ModBlocks2.RAW_COPPER_DOOR);
                        entries.add(ModBlocks2.RAW_COPPER_TRAPDOOR);
                        entries.add(ModBlocks2.RAW_COPPER_PRESSURE_PLATE);
                        entries.add(ModBlocks2.RAW_COPPER_BUTTON);
                        //raw_gold_block
                        entries.add(ModBlocks2.RAW_GOLD_STAIRS);
                        entries.add(ModBlocks2.RAW_GOLD_SLAB);
                        entries.add(ModBlocks2.RAW_GOLD_WALL);
                        entries.add(ModBlocks2.RAW_GOLD_FENCE);
                        entries.add(ModBlocks2.RAW_GOLD_FENCE_GATE);
                        entries.add(ModBlocks2.RAW_GOLD_DOOR);
                        entries.add(ModBlocks2.RAW_GOLD_TRAPDOOR);
                        entries.add(ModBlocks2.RAW_GOLD_PRESSURE_PLATE);
                        entries.add(ModBlocks2.RAW_GOLD_BUTTON);
                        //glowstone_block
                        entries.add(ModBlocks2.GLOWSTONE_STAIRS);
                        entries.add(ModBlocks2.GLOWSTONE_SLAB);
                        entries.add(ModBlocks2.GLOWSTONE_WALL);
                        entries.add(ModBlocks2.GLOWSTONE_FENCE);
                        entries.add(ModBlocks2.GLOWSTONE_FENCE_GATE);
                        entries.add(ModBlocks2.GLOWSTONE_DOOR);
                        entries.add(ModBlocks2.GLOWSTONE_TRAPDOOR);
                        entries.add(ModBlocks2.GLOWSTONE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.GLOWSTONE_BUTTON);
                        //oak_leaves_block
                        entries.add(ModBlocks2.OAK_LEAVES_STAIRS);
                        entries.add(ModBlocks2.OAK_LEAVES_SLAB);
                        entries.add(ModBlocks2.OAK_LEAVES_WALL);
                        entries.add(ModBlocks2.OAK_LEAVES_FENCE);
                        entries.add(ModBlocks2.OAK_LEAVES_FENCE_GATE);
                        entries.add(ModBlocks2.OAK_LEAVES_DOOR);
                        entries.add(ModBlocks2.OAK_LEAVES_TRAPDOOR);
                        entries.add(ModBlocks2.OAK_LEAVES_PRESSURE_PLATE);
                        entries.add(ModBlocks2.OAK_LEAVES_BUTTON);
                        //spruce_leaves_block
                        entries.add(ModBlocks2.SPRUCE_LEAVES_STAIRS);
                        entries.add(ModBlocks2.SPRUCE_LEAVES_SLAB);
                        entries.add(ModBlocks2.SPRUCE_LEAVES_WALL);
                        entries.add(ModBlocks2.SPRUCE_LEAVES_FENCE);
                        entries.add(ModBlocks2.SPRUCE_LEAVES_FENCE_GATE);
                        entries.add(ModBlocks2.SPRUCE_LEAVES_DOOR);
                        entries.add(ModBlocks2.SPRUCE_LEAVES_TRAPDOOR);
                        entries.add(ModBlocks2.SPRUCE_LEAVES_PRESSURE_PLATE);
                        entries.add(ModBlocks2.SPRUCE_LEAVES_BUTTON);
                        //birch_leaves_block
                        entries.add(ModBlocks2.BIRCH_LEAVES_STAIRS);
                        entries.add(ModBlocks2.BIRCH_LEAVES_SLAB);
                        entries.add(ModBlocks2.BIRCH_LEAVES_WALL);
                        entries.add(ModBlocks2.BIRCH_LEAVES_FENCE);
                        entries.add(ModBlocks2.BIRCH_LEAVES_FENCE_GATE);
                        entries.add(ModBlocks2.BIRCH_LEAVES_DOOR);
                        entries.add(ModBlocks2.BIRCH_LEAVES_TRAPDOOR);
                        entries.add(ModBlocks2.BIRCH_LEAVES_PRESSURE_PLATE);
                        entries.add(ModBlocks2.BIRCH_LEAVES_BUTTON);
                        //jungle_leaves_block
                        entries.add(ModBlocks2.JUNGLE_LEAVES_STAIRS);
                        entries.add(ModBlocks2.JUNGLE_LEAVES_SLAB);
                        entries.add(ModBlocks2.JUNGLE_LEAVES_WALL);
                        entries.add(ModBlocks2.JUNGLE_LEAVES_FENCE);
                        entries.add(ModBlocks2.JUNGLE_LEAVES_FENCE_GATE);
                        entries.add(ModBlocks2.JUNGLE_LEAVES_DOOR);
                        entries.add(ModBlocks2.JUNGLE_LEAVES_TRAPDOOR);
                        entries.add(ModBlocks2.JUNGLE_LEAVES_PRESSURE_PLATE);
                        entries.add(ModBlocks2.JUNGLE_LEAVES_BUTTON);
                        //acacia_leaves_block
                        entries.add(ModBlocks2.ACACIA_LEAVES_STAIRS);
                        entries.add(ModBlocks2.ACACIA_LEAVES_SLAB);
                        entries.add(ModBlocks2.ACACIA_LEAVES_WALL);
                        entries.add(ModBlocks2.ACACIA_LEAVES_FENCE);
                        entries.add(ModBlocks2.ACACIA_LEAVES_FENCE_GATE);
                        entries.add(ModBlocks2.ACACIA_LEAVES_DOOR);
                        entries.add(ModBlocks2.ACACIA_LEAVES_TRAPDOOR);
                        entries.add(ModBlocks2.ACACIA_LEAVES_PRESSURE_PLATE);
                        entries.add(ModBlocks2.ACACIA_LEAVES_BUTTON);
                        //dark_oak_leaves_block
                        entries.add(ModBlocks2.DARK_OAK_LEAVES_STAIRS);
                        entries.add(ModBlocks2.DARK_OAK_LEAVES_SLAB);
                        entries.add(ModBlocks2.DARK_OAK_LEAVES_WALL);
                        entries.add(ModBlocks2.DARK_OAK_LEAVES_FENCE);
                        entries.add(ModBlocks2.DARK_OAK_LEAVES_FENCE_GATE);
                        entries.add(ModBlocks2.DARK_OAK_LEAVES_DOOR);
                        entries.add(ModBlocks2.DARK_OAK_LEAVES_TRAPDOOR);
                        entries.add(ModBlocks2.DARK_OAK_LEAVES_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DARK_OAK_LEAVES_BUTTON);
                        //mangrove_leaves_block
                        entries.add(ModBlocks2.MANGROVE_LEAVES_STAIRS);
                        entries.add(ModBlocks2.MANGROVE_LEAVES_SLAB);
                        entries.add(ModBlocks2.MANGROVE_LEAVES_WALL);
                        entries.add(ModBlocks2.MANGROVE_LEAVES_FENCE);
                        entries.add(ModBlocks2.MANGROVE_LEAVES_FENCE_GATE);
                        entries.add(ModBlocks2.MANGROVE_LEAVES_DOOR);
                        entries.add(ModBlocks2.MANGROVE_LEAVES_TRAPDOOR);
                        entries.add(ModBlocks2.MANGROVE_LEAVES_PRESSURE_PLATE);
                        entries.add(ModBlocks2.MANGROVE_LEAVES_BUTTON);
                        //cherry_leaves_block
                        entries.add(ModBlocks2.CHERRY_LEAVES_STAIRS);
                        entries.add(ModBlocks2.CHERRY_LEAVES_SLAB);
                        entries.add(ModBlocks2.CHERRY_LEAVES_WALL);
                        entries.add(ModBlocks2.CHERRY_LEAVES_FENCE);
                        entries.add(ModBlocks2.CHERRY_LEAVES_FENCE_GATE);
                        entries.add(ModBlocks2.CHERRY_LEAVES_DOOR);
                        ...
                        entries.add(ModBlocks2.AZALEA_LEAVES_WALL);
                        entries.add(ModBlocks2.AZALEA_LEAVES_FENCE);
                        entries.add(ModBlocks2.AZALEA_LEAVES_FENCE_GATE);
                        entries.add(ModBlocks2.AZALEA_LEAVES_DOOR);
                        entries.add(ModBlocks2.AZALEA_LEAVES_TRAPDOOR);
                        entries.add(ModBlocks2.AZALEA_LEAVES_PRESSURE_PLATE);
                        entries.add(ModBlocks2.AZALEA_LEAVES_BUTTON);
                        //flowering_azalea_leaves_block
                        entries.add(ModBlocks2.FLOWERING_AZALEA_LEAVES_STAIRS);
                        entries.add(ModBlocks2.FLOWERING_AZALEA_LEAVES_SLAB);
                        entries.add(ModBlocks2.FLOWERING_AZALEA_LEAVES_WALL);
                        entries.add(ModBlocks2.FLOWERING_AZALEA_LEAVES_FENCE);
                        entries.add(ModBlocks2.FLOWERING_AZALEA_LEAVES_FENCE_GATE);
                        entries.add(ModBlocks2.FLOWERING_AZALEA_LEAVES_DOOR);
                        entries.add(ModBlocks2.FLOWERING_AZALEA_LEAVES_TRAPDOOR);
                        entries.add(ModBlocks2.FLOWERING_AZALEA_LEAVES_PRESSURE_PLATE);
                        entries.add(ModBlocks2.FLOWERING_AZALEA_LEAVES_BUTTON);
                        //brown_mushroom_block
                        entries.add(ModBlocks2.BROWN_MUSHROOM_STAIRS);
                        entries.add(ModBlocks2.BROWN_MUSHROOM_SLAB);
                        entries.add(ModBlocks2.BROWN_MUSHROOM_WALL);
                        entries.add(ModBlocks2.BROWN_MUSHROOM_FENCE);
                        entries.add(ModBlocks2.BROWN_MUSHROOM_FENCE_GATE);
                        entries.add(ModBlocks2.BROWN_MUSHROOM_DOOR);
                        entries.add(ModBlocks2.BROWN_MUSHROOM_TRAPDOOR);
                        entries.add(ModBlocks2.BROWN_MUSHROOM_PRESSURE_PLATE);
                        entries.add(ModBlocks2.BROWN_MUSHROOM_BUTTON);
                        //red_mushroom_block
                        entries.add(ModBlocks2.RED_MUSHROOM_STAIRS);
                        entries.add(ModBlocks2.RED_MUSHROOM_SLAB);
                        entries.add(ModBlocks2.RED_MUSHROOM_WALL);
                        entries.add(ModBlocks2.RED_MUSHROOM_FENCE);
                        entries.add(ModBlocks2.RED_MUSHROOM_FENCE_GATE);
                        entries.add(ModBlocks2.RED_MUSHROOM_DOOR);
                        entries.add(ModBlocks2.RED_MUSHROOM_TRAPDOOR);
                        entries.add(ModBlocks2.RED_MUSHROOM_PRESSURE_PLATE);
                        entries.add(ModBlocks2.RED_MUSHROOM_BUTTON);
                        //nether_wart
                        entries.add(ModBlocks2.NETHER_WART_STAIRS);
                        entries.add(ModBlocks2.NETHER_WART_SLAB);
                        entries.add(ModBlocks2.NETHER_WART_WALL);
                        entries.add(ModBlocks2.NETHER_WART_FENCE);
                        entries.add(ModBlocks2.NETHER_WART_FENCE_GATE);
                        entries.add(ModBlocks2.NETHER_WART_DOOR);
                        entries.add(ModBlocks2.NETHER_WART_TRAPDOOR);
                        entries.add(ModBlocks2.NETHER_WART_PRESSURE_PLATE);
                        entries.add(ModBlocks2.NETHER_WART_BUTTON);
                        //warped_wart
                        entries.add(ModBlocks2.WARPED_WART_STAIRS);
                        entries.add(ModBlocks2.WARPED_WART_SLAB);
                        entries.add(ModBlocks2.WARPED_WART_WALL);
                        entries.add(ModBlocks2.WARPED_WART_FENCE);
                        entries.add(ModBlocks2.WARPED_WART_FENCE_GATE);
                        entries.add(ModBlocks2.WARPED_WART_DOOR);
                        entries.add(ModBlocks2.WARPED_WART_TRAPDOOR);
                        entries.add(ModBlocks2.WARPED_WART_PRESSURE_PLATE);
                        entries.add(ModBlocks2.WARPED_WART_BUTTON);
                        //shroomlight
                        entries.add(ModBlocks2.SHROOMLIGHT_STAIRS);
                        entries.add(ModBlocks2.SHROOMLIGHT_SLAB);
                        entries.add(ModBlocks2.SHROOMLIGHT_WALL);
                        entries.add(ModBlocks2.SHROOMLIGHT_FENCE);
                        entries.add(ModBlocks2.SHROOMLIGHT_FENCE_GATE);
                        entries.add(ModBlocks2.SHROOMLIGHT_DOOR);
                        entries.add(ModBlocks2.SHROOMLIGHT_TRAPDOOR);
                        entries.add(ModBlocks2.SHROOMLIGHT_PRESSURE_PLATE);
                        entries.add(ModBlocks2.SHROOMLIGHT_BUTTON);
                        //dried_kelp
                        entries.add(ModBlocks2.DRIED_KELP_STAIRS);
                        entries.add(ModBlocks2.DRIED_KELP_SLAB);
                        entries.add(ModBlocks2.DRIED_KELP_WALL);
                        entries.add(ModBlocks2.DRIED_KELP_FENCE);
                        entries.add(ModBlocks2.DRIED_KELP_FENCE_GATE);
                        entries.add(ModBlocks2.DRIED_KELP_DOOR);
                        entries.add(ModBlocks2.DRIED_KELP_TRAPDOOR);
                        entries.add(ModBlocks2.DRIED_KELP_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DRIED_KELP_BUTTON);
                        //tube_coral_block
                        entries.add(ModBlocks2.TUBE_CORAL_STAIRS);
                        entries.add(ModBlocks2.TUBE_CORAL_SLAB);
                        entries.add(ModBlocks2.TUBE_CORAL_WALL);
                        entries.add(ModBlocks2.TUBE_CORAL_FENCE);
                        entries.add(ModBlocks2.TUBE_CORAL_FENCE_GATE);
                        entries.add(ModBlocks2.TUBE_CORAL_DOOR);
                        entries.add(ModBlocks2.TUBE_CORAL_TRAPDOOR);
                        entries.add(ModBlocks2.TUBE_CORAL_PRESSURE_PLATE);
                        entries.add(ModBlocks2.TUBE_CORAL_BUTTON);
                        //brain_coral_block
                        entries.add(ModBlocks2.BRAIN_CORAL_STAIRS);
                        entries.add(ModBlocks2.BRAIN_CORAL_SLAB);
                        entries.add(ModBlocks2.BRAIN_CORAL_WALL);
                        entries.add(ModBlocks2.BRAIN_CORAL_FENCE);
                        entries.add(ModBlocks2.BRAIN_CORAL_FENCE_GATE);
                        entries.add(ModBlocks2.BRAIN_CORAL_DOOR);
                        entries.add(ModBlocks2.BRAIN_CORAL_TRAPDOOR);
                        entries.add(ModBlocks2.BRAIN_CORAL_PRESSURE_PLATE);
                        entries.add(ModBlocks2.BRAIN_CORAL_BUTTON);
                        //bubble_coral_block
                        entries.add(ModBlocks2.BUBBLE_CORAL_STAIRS);
                        entries.add(ModBlocks2.BUBBLE_CORAL_SLAB);
                        entries.add(ModBlocks2.BUBBLE_CORAL_WALL);
                        entries.add(ModBlocks2.BUBBLE_CORAL_FENCE);
                        entries.add(ModBlocks2.BUBBLE_CORAL_FENCE_GATE);
                        entries.add(ModBlocks2.BUBBLE_CORAL_DOOR);
                        entries.add(ModBlocks2.BUBBLE_CORAL_TRAPDOOR);
                        entries.add(ModBlocks2.BUBBLE_CORAL_PRESSURE_PLATE);
                        entries.add(ModBlocks2.BUBBLE_CORAL_BUTTON);
                        //fire_coral_block
                        entries.add(ModBlocks2.FIRE_CORAL_STAIRS);
                        entries.add(ModBlocks2.FIRE_CORAL_SLAB);
                        entries.add(ModBlocks2.FIRE_CORAL_WALL);
                        entries.add(ModBlocks2.FIRE_CORAL_FENCE);
                        entries.add(ModBlocks2.FIRE_CORAL_FENCE_GATE);
                        entries.add(ModBlocks2.FIRE_CORAL_DOOR);
                        entries.add(ModBlocks2.FIRE_CORAL_TRAPDOOR);
                        entries.add(ModBlocks2.FIRE_CORAL_PRESSURE_PLATE);
                        entries.add(ModBlocks2.FIRE_CORAL_BUTTON);
                        //horn_coral_block
                        entries.add(ModBlocks2.HORN_CORAL_STAIRS);
                        entries.add(ModBlocks2.HORN_CORAL_SLAB);
                        entries.add(ModBlocks2.HORN_CORAL_WALL);
                        entries.add(ModBlocks2.HORN_CORAL_FENCE);
                        entries.add(ModBlocks2.HORN_CORAL_FENCE_GATE);
                        entries.add(ModBlocks2.HORN_CORAL_DOOR);
                        entries.add(ModBlocks2.HORN_CORAL_TRAPDOOR);
                        entries.add(ModBlocks2.HORN_CORAL_PRESSURE_PLATE);
                        entries.add(ModBlocks2.HORN_CORAL_BUTTON);
                        //dead_coral_block
                        entries.add(ModBlocks2.DEAD_TUBE_CORAL_STAIRS);
                        entries.add(ModBlocks2.DEAD_TUBE_CORAL_SLAB);
                        entries.add(ModBlocks2.DEAD_TUBE_CORAL_WALL);
                        entries.add(ModBlocks2.DEAD_TUBE_CORAL_FENCE);
                        entries.add(ModBlocks2.DEAD_TUBE_CORAL_FENCE_GATE);
                        entries.add(ModBlocks2.DEAD_TUBE_CORAL_DOOR);
                        entries.add(ModBlocks2.DEAD_TUBE_CORAL_TRAPDOOR);
                        entries.add(ModBlocks2.DEAD_TUBE_CORAL_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DEAD_TUBE_CORAL_BUTTON);
                        //dead_coral_block
                        entries.add(ModBlocks2.DEAD_BRAIN_CORAL_STAIRS);
                        entries.add(ModBlocks2.DEAD_BRAIN_CORAL_SLAB);
                        entries.add(ModBlocks2.DEAD_BRAIN_CORAL_WALL);
                        entries.add(ModBlocks2.DEAD_BRAIN_CORAL_FENCE);
                        entries.add(ModBlocks2.DEAD_BRAIN_CORAL_FENCE_GATE);
                        entries.add(ModBlocks2.DEAD_BRAIN_CORAL_DOOR);
                        entries.add(ModBlocks2.DEAD_BRAIN_CORAL_TRAPDOOR);
                        entries.add(ModBlocks2.DEAD_BRAIN_CORAL_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DEAD_BRAIN_CORAL_BUTTON);
                        //dead_coral_block
                        entries.add(ModBlocks2.DEAD_BUBBLE_CORAL_STAIRS);
                        entries.add(ModBlocks2.DEAD_BUBBLE_CORAL_SLAB);
                        entries.add(ModBlocks2.DEAD_BUBBLE_CORAL_WALL);
                        entries.add(ModBlocks2.DEAD_BUBBLE_CORAL_FENCE);
                        entries.add(ModBlocks2.DEAD_BUBBLE_CORAL_FENCE_GATE);
                        entries.add(ModBlocks2.DEAD_BUBBLE_CORAL_DOOR);
                        entries.add(ModBlocks2.DEAD_BUBBLE_CORAL_TRAPDOOR);
                        entries.add(ModBlocks2.DEAD_BUBBLE_CORAL_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DEAD_BUBBLE_CORAL_BUTTON);
                        //dead_coral_block
                        entries.add(ModBlocks2.DEAD_FIRE_CORAL_STAIRS);
                        entries.add(ModBlocks2.DEAD_FIRE_CORAL_SLAB);
                        entries.add(ModBlocks2.DEAD_FIRE_CORAL_WALL);
                        entries.add(ModBlocks2.DEAD_FIRE_CORAL_FENCE);
                        entries.add(ModBlocks2.DEAD_FIRE_CORAL_FENCE_GATE);
                        entries.add(ModBlocks2.DEAD_FIRE_CORAL_DOOR);
                        entries.add(ModBlocks2.DEAD_FIRE_CORAL_TRAPDOOR);
                        entries.add(ModBlocks2.DEAD_FIRE_CORAL_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DEAD_FIRE_CORAL_BUTTON);
                        //dead_coral_block
                        entries.add(ModBlocks2.DEAD_HORN_CORAL_STAIRS);
                        entries.add(ModBlocks2.DEAD_HORN_CORAL_SLAB);
                        entries.add(ModBlocks2.DEAD_HORN_CORAL_WALL);
                        entries.add(ModBlocks2.DEAD_HORN_CORAL_FENCE);
                        entries.add(ModBlocks2.DEAD_HORN_CORAL_FENCE_GATE);
                        entries.add(ModBlocks2.DEAD_HORN_CORAL_DOOR);
                        entries.add(ModBlocks2.DEAD_HORN_CORAL_TRAPDOOR);
                        entries.add(ModBlocks2.DEAD_HORN_CORAL_PRESSURE_PLATE);
                        entries.add(ModBlocks2.DEAD_HORN_CORAL_BUTTON);
                        //sponge
                        entries.add(ModBlocks2.SPONGE_STAIRS);
                        entries.add(ModBlocks2.SPONGE_SLAB);
                        entries.add(ModBlocks2.SPONGE_WALL);
                        entries.add(ModBlocks2.SPONGE_FENCE);
                        entries.add(ModBlocks2.SPONGE_FENCE_GATE);
                        entries.add(ModBlocks2.SPONGE_DOOR);
                        entries.add(ModBlocks2.SPONGE_TRAPDOOR);
                        entries.add(ModBlocks2.SPONGE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.SPONGE_BUTTON);
                        //wet_sponge
                        entries.add(ModBlocks2.WET_SPONGE_STAIRS);
                        entries.add(ModBlocks2.WET_SPONGE_SLAB);
                        entries.add(ModBlocks2.WET_SPONGE_WALL);
                        entries.add(ModBlocks2.WET_SPONGE_FENCE);
                        entries.add(ModBlocks2.WET_SPONGE_FENCE_GATE);
                        entries.add(ModBlocks2.WET_SPONGE_DOOR);
                        entries.add(ModBlocks2.WET_SPONGE_TRAPDOOR);
                        entries.add(ModBlocks2.WET_SPONGE_PRESSURE_PLATE);
                        entries.add(ModBlocks2.WET_SPONGE_BUTTON);
                        //melon
                        entries.add(ModBlocks2.MELON_STAIRS);
                        entries.add(ModBlocks2.MELON_SLAB);
                        entries.add(ModBlocks2.MELON_WALL);
                        entries.add(ModBlocks2.MELON_FENCE);
                        entries.add(ModBlocks2.MELON_FENCE_GATE);
                        entries.add(ModBlocks2.MELON_DOOR);
                        entries.add(ModBlocks2.MELON_TRAPDOOR);
                        entries.add(ModBlocks2.MELON_PRESSURE_PLATE);
                        entries.add(ModBlocks2.MELON_BUTTON);
                        //pumpkin
                        entries.add(ModBlocks2.PUMPKIN_STAIRS);
                        entries.add(ModBlocks2.PUMPKIN_SLAB);
                        entries.add(ModBlocks2.PUMPKIN_WALL);
                        entries.add(ModBlocks2.PUMPKIN_FENCE);
                        entries.add(ModBlocks2.PUMPKIN_FENCE_GATE);
                        entries.add(ModBlocks2.PUMPKIN_DOOR);
                        entries.add(ModBlocks2.PUMPKIN_TRAPDOOR);
                        entries.add(ModBlocks2.PUMPKIN_PRESSURE_PLATE);
                        entries.add(ModBlocks2.PUMPKIN_BUTTON);
                        //hay_block
                        entries.add(ModBlocks2.HAY_BLOCK_STAIRS);
                        entries.add(ModBlocks2.HAY_BLOCK_SLAB);
                        entries.add(ModBlocks2.HAY_BLOCK_WALL);
                        entries.add(ModBlocks2.HAY_BLOCK_FENCE);
                        entries.add(ModBlocks2.HAY_BLOCK_FENCE_GATE);
                        entries.add(ModBlocks2.HAY_BLOCK_DOOR);
                        entries.add(ModBlocks2.HAY_BLOCK_TRAPDOOR);
                        entries.add(ModBlocks2.HAY_BLOCK_PRESSURE_PLATE);
                        entries.add(ModBlocks2.HAY_BLOCK_BUTTON);
                        //honeycomb
                        entries.add(ModBlocks2.HONEYCOMB_STAIRS);
                        entries.add(ModBlocks2.HONEYCOMB_SLAB);
                        entries.add(ModBlocks2.HONEYCOMB_WALL);
                        entries.add(ModBlocks2.HONEYCOMB_FENCE);
                        entries.add(ModBlocks2.HONEYCOMB_FENCE_GATE);
                        entries.add(ModBlocks2.HONEYCOMB_DOOR);
                        entries.add(ModBlocks2.HONEYCOMB_TRAPDOOR);
                        entries.add(ModBlocks2.HONEYCOMB_PRESSURE_PLATE);
                        entries.add(ModBlocks2.HONEYCOMB_BUTTON);
                        //SLIME
                        entries.add(ModBlocks2.SLIME_STAIRS);
                        entries.add(ModBlocks2.SLIME_SLAB);
                        entries.add(ModBlocks2.SLIME_WALL);
                        entries.add(ModBlocks2.SLIME_FENCE);
                        entries.add(ModBlocks2.SLIME_FENCE_GATE);
                        entries.add(ModBlocks2.SLIME_DOOR);
                        entries.add(ModBlocks2.SLIME_TRAPDOOR);
                        entries.add(ModBlocks2.SLIME_PRESSURE_PLATE);
                        entries.add(ModBlocks2.SLIME_BUTTON);
                        //HONEY
                        entries.add(ModBlocks2.HONEY_STAIRS);
                        entries.add(ModBlocks2.HONEY_SLAB);
                        entries.add(ModBlocks2.HONEY_WALL);
                        entries.add(ModBlocks2.HONEY_FENCE);
                        entries.add(ModBlocks2.HONEY_FENCE_GATE);
                        entries.add(ModBlocks2.HONEY_DOOR);
                        ...
                        entries.add(ModBlocks2.OCHRE_FROGLIGHT_WALL);
                        entries.add(ModBlocks2.OCHRE_FROGLIGHT_FENCE);
                        entries.add(ModBlocks2.OCHRE_FROGLIGHT_FENCE_GATE);
                        entries.add(ModBlocks2.OCHRE_FROGLIGHT_DOOR);
                        entries.add(ModBlocks2.OCHRE_FROGLIGHT_TRAPDOOR);
                        entries.add(ModBlocks2.OCHRE_FROGLIGHT_PRESSURE_PLATE);
                        entries.add(ModBlocks2.OCHRE_FROGLIGHT_BUTTON);
                        //verdant_froglight
                        entries.add(ModBlocks2.VERDANT_FROGLIGHT_STAIRS);
                        entries.add(ModBlocks2.VERDANT_FROGLIGHT_SLAB);
                        entries.add(ModBlocks2.VERDANT_FROGLIGHT_WALL);
                        entries.add(ModBlocks2.VERDANT_FROGLIGHT_FENCE);
                        entries.add(ModBlocks2.VERDANT_FROGLIGHT_FENCE_GATE);
                        entries.add(ModBlocks2.VERDANT_FROGLIGHT_DOOR);
                        entries.add(ModBlocks2.VERDANT_FROGLIGHT_TRAPDOOR);
                        entries.add(ModBlocks2.VERDANT_FROGLIGHT_PRESSURE_PLATE);
                        entries.add(ModBlocks2.VERDANT_FROGLIGHT_BUTTON);
                        //pearlescent_froglight
                        entries.add(ModBlocks2.PEARLESCENT_FROGLIGHT_STAIRS);
                        entries.add(ModBlocks2.PEARLESCENT_FROGLIGHT_SLAB);
                        entries.add(ModBlocks2.PEARLESCENT_FROGLIGHT_WALL);
                        entries.add(ModBlocks2.PEARLESCENT_FROGLIGHT_FENCE);
                        entries.add(ModBlocks2.PEARLESCENT_FROGLIGHT_FENCE_GATE);
                        entries.add(ModBlocks2.PEARLESCENT_FROGLIGHT_DOOR);
                        entries.add(ModBlocks2.PEARLESCENT_FROGLIGHT_TRAPDOOR);
                        entries.add(ModBlocks2.PEARLESCENT_FROGLIGHT_PRESSURE_PLATE);
                        entries.add(ModBlocks2.PEARLESCENT_FROGLIGHT_BUTTON);
                        //sculk
                        entries.add(ModBlocks2.SCULK_STAIRS);
                        entries.add(ModBlocks2.SCULK_SLAB);
                        entries.add(ModBlocks2.SCULK_WALL);
                        entries.add(ModBlocks2.SCULK_FENCE);
                        entries.add(ModBlocks2.SCULK_FENCE_GATE);
                        entries.add(ModBlocks2.SCULK_DOOR);
                        entries.add(ModBlocks2.SCULK_TRAPDOOR);
                        entries.add(ModBlocks2.SCULK_PRESSURE_PLATE);
                        entries.add(ModBlocks2.SCULK_BUTTON);
                        //bedrock
                        entries.add(ModBlocks2.BEDROCK_STAIRS);
                        entries.add(ModBlocks2.BEDROCK_SLAB);
                        entries.add(ModBlocks2.BEDROCK_WALL);
                        entries.add(ModBlocks2.BEDROCK_FENCE);
                        entries.add(ModBlocks2.BEDROCK_FENCE_GATE);
                        entries.add(ModBlocks2.BEDROCK_DOOR);
                        entries.add(ModBlocks2.BEDROCK_TRAPDOOR);
                        entries.add(ModBlocks2.BEDROCK_PRESSURE_PLATE);
                        entries.add(ModBlocks2.BEDROCK_BUTTON);
                        //target
                        entries.add(ModBlocks2.TARGET_STAIRS);
                        entries.add(ModBlocks2.TARGET_SLAB);
                        entries.add(ModBlocks2.TARGET_WALL);
                        entries.add(ModBlocks2.TARGET_FENCE);
                        entries.add(ModBlocks2.TARGET_FENCE_GATE);
                        entries.add(ModBlocks2.TARGET_DOOR);
                        entries.add(ModBlocks2.TARGET_TRAPDOOR);
    ...
    public static void addWallsToBuildingBlocks(FabricItemGroupEntries entries) {
        entries.addAfter(Blocks.OAK_SLAB, ModBlocks.OAK_WALL);
        entries.addAfter(Blocks.SPRUCE_SLAB, ModBlocks.SPRUCE_WALL);
        entries.addAfter(Blocks.BIRCH_SLAB, ModBlocks.BIRCH_WALL);
        entries.addAfter(Blocks.JUNGLE_SLAB, ModBlocks.JUNGLE_WALL);
        entries.addAfter(Blocks.ACACIA_SLAB, ModBlocks.ACACIA_WALL);
        entries.addAfter(Blocks.DARK_OAK_SLAB, ModBlocks.DARK_OAK_WALL);
        entries.addAfter(Blocks.MANGROVE_SLAB, ModBlocks.MANGROVE_WALL);
        entries.addAfter(Blocks.CHERRY_SLAB, ModBlocks.CHERRY_WALL);
        entries.addAfter(Blocks.PALE_OAK_SLAB, ModBlocks.PALE_OAK_WALL);
        entries.addAfter(Blocks.BAMBOO_SLAB, ModBlocks.BAMBOO_WALL);
        entries.addAfter(Blocks.CRIMSON_SLAB, ModBlocks.CRIMSON_WALL);
        entries.addAfter(Blocks.WARPED_SLAB, ModBlocks.WARPED_WALL);
    }
