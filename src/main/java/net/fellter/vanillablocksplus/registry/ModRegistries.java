...
public class ModRegistries {
	...
	public static void registerTransparentBlocks() {
		BlockRenderLayerMap.putBlocks(BlockRenderLayer.CUTOUT,
				...
				ModBlocks2.PALE_OAK_LEAVES_BUTTON,
				ModBlocks2.PALE_OAK_LEAVES_FENCE,
				ModBlocks2.PALE_OAK_LEAVES_SLAB,
				ModBlocks2.PALE_OAK_LEAVES_STAIRS,
				ModBlocks2.PALE_OAK_LEAVES_WALL,
				ModBlocks2.PALE_OAK_LEAVES_FENCE_GATE,
				ModBlocks2.PALE_OAK_LEAVES_DOOR,
				ModBlocks2.PALE_OAK_LEAVES_TRAPDOOR,
				ModBlocks2.PALE_OAK_LEAVES_PRESSURE_PLATE,
	...
	private static void registerStrippable(Block input, Block stripped) {
		StrippableBlockRegistry.register(input, stripped, StrippableBlockRegistry.StrippingTransformer.COPY);
	}

	public static void registerStrippables() {
		//oak
		registerStrippable(ModBlocks.OAK_WOOD_BUTTON, ModBlocks.STR_OAK_WOOD_BUTTON);
		registerStrippable(ModBlocks.OAK_WOOD_FENCE, ModBlocks.STR_OAK_WOOD_FENCE);
		registerStrippable(ModBlocks.OAK_WOOD_SLAB, ModBlocks.STR_OAK_WOOD_SLAB);
		registerStrippable(ModBlocks.OAK_WOOD_STAIRS, ModBlocks.STR_OAK_WOOD_STAIRS);
		registerStrippable(ModBlocks.OAK_WOOD_FENCE_GATE, ModBlocks.STR_OAK_WOOD_FENCE_GATE);
		registerStrippable(ModBlocks.OAK_WOOD_DOOR, ModBlocks.STR_OAK_WOOD_DOOR);
		registerStrippable(ModBlocks.OAK_WOOD_TRAPDOOR, ModBlocks.STR_OAK_WOOD_TRAPDOOR);
		registerStrippable(ModBlocks.OAK_WOOD_PRESSURE_PLATE, ModBlocks.STR_OAK_WOOD_PRESSURE_PLATE);
		registerStrippable(ModBlocks.OAK_WOOD_WALL, ModBlocks.STR_OAK_WOOD_WALL);
		//oak
		registerStrippable(ModBlocks2.OAK_LOG_BUTTON, ModBlocks2.STR_OAK_LOG_BUTTON);
		registerStrippable(ModBlocks2.OAK_LOG_FENCE, ModBlocks2.STR_OAK_LOG_FENCE);
		registerStrippable(ModBlocks2.OAK_LOG_SLAB, ModBlocks2.STR_OAK_LOG_SLAB);
		registerStrippable(ModBlocks2.OAK_LOG_STAIRS, ModBlocks2.STR_OAK_LOG_STAIRS);
		registerStrippable(ModBlocks2.OAK_LOG_FENCE_GATE, ModBlocks2.STR_OAK_LOG_FENCE_GATE);
		registerStrippable(ModBlocks2.OAK_LOG_DOOR, ModBlocks2.STR_OAK_LOG_DOOR);
		registerStrippable(ModBlocks2.OAK_LOG_TRAPDOOR, ModBlocks2.STR_OAK_LOG_TRAPDOOR);
		registerStrippable(ModBlocks2.OAK_LOG_PRESSURE_PLATE, ModBlocks2.STR_OAK_LOG_PRESSURE_PLATE);
		registerStrippable(ModBlocks2.OAK_LOG_WALL, ModBlocks2.STR_OAK_LOG_WALL);
		//spruce
		registerStrippable(ModBlocks.SPRUCE_WOOD_BUTTON, ModBlocks.STR_SPRUCE_WOOD_BUTTON);
		registerStrippable(ModBlocks.SPRUCE_WOOD_FENCE, ModBlocks.STR_SPRUCE_WOOD_FENCE);
		registerStrippable(ModBlocks.SPRUCE_WOOD_SLAB, ModBlocks.STR_SPRUCE_WOOD_SLAB);
		registerStrippable(ModBlocks.SPRUCE_WOOD_STAIRS, ModBlocks.STR_SPRUCE_WOOD_STAIRS);
		registerStrippable(ModBlocks.SPRUCE_WOOD_FENCE_GATE, ModBlocks.STR_SPRUCE_WOOD_FENCE_GATE);
		registerStrippable(ModBlocks.SPRUCE_WOOD_DOOR, ModBlocks.STR_SPRUCE_WOOD_DOOR);
		registerStrippable(ModBlocks.SPRUCE_WOOD_TRAPDOOR, ModBlocks.STR_SPRUCE_WOOD_TRAPDOOR);
		registerStrippable(ModBlocks.SPRUCE_WOOD_PRESSURE_PLATE, ModBlocks.STR_SPRUCE_WOOD_PRESSURE_PLATE);
		registerStrippable(ModBlocks.SPRUCE_WOOD_WALL, ModBlocks.STR_SPRUCE_WOOD_WALL);
		//spruce
		registerStrippable(ModBlocks2.SPRUCE_LOG_BUTTON, ModBlocks2.STR_SPRUCE_LOG_BUTTON);
		registerStrippable(ModBlocks2.SPRUCE_LOG_FENCE, ModBlocks2.STR_SPRUCE_LOG_FENCE);
		registerStrippable(ModBlocks2.SPRUCE_LOG_SLAB, ModBlocks2.STR_SPRUCE_LOG_SLAB);
		registerStrippable(ModBlocks2.SPRUCE_LOG_STAIRS, ModBlocks2.STR_SPRUCE_LOG_STAIRS);
		registerStrippable(ModBlocks2.SPRUCE_LOG_FENCE_GATE, ModBlocks2.STR_SPRUCE_LOG_FENCE_GATE);
		registerStrippable(ModBlocks2.SPRUCE_LOG_DOOR, ModBlocks2.STR_SPRUCE_LOG_DOOR);
		registerStrippable(ModBlocks2.SPRUCE_LOG_TRAPDOOR, ModBlocks2.STR_SPRUCE_LOG_TRAPDOOR);
		registerStrippable(ModBlocks2.SPRUCE_LOG_PRESSURE_PLATE, ModBlocks2.STR_SPRUCE_LOG_PRESSURE_PLATE);
		registerStrippable(ModBlocks2.SPRUCE_LOG_WALL, ModBlocks2.STR_SPRUCE_LOG_WALL);
		//birch
		registerStrippable(ModBlocks.BIRCH_WOOD_BUTTON, ModBlocks.STR_BIRCH_WOOD_BUTTON);
		registerStrippable(ModBlocks.BIRCH_WOOD_FENCE, ModBlocks.STR_BIRCH_WOOD_FENCE);
		registerStrippable(ModBlocks.BIRCH_WOOD_SLAB, ModBlocks.STR_BIRCH_WOOD_SLAB);
		registerStrippable(ModBlocks.BIRCH_WOOD_STAIRS, ModBlocks.STR_BIRCH_WOOD_STAIRS);
		registerStrippable(ModBlocks.BIRCH_WOOD_FENCE_GATE, ModBlocks.STR_BIRCH_WOOD_FENCE_GATE);
		registerStrippable(ModBlocks.BIRCH_WOOD_DOOR, ModBlocks.STR_BIRCH_WOOD_DOOR);
		registerStrippable(ModBlocks.BIRCH_WOOD_TRAPDOOR, ModBlocks.STR_BIRCH_WOOD_TRAPDOOR);
		registerStrippable(ModBlocks.BIRCH_WOOD_PRESSURE_PLATE, ModBlocks.STR_BIRCH_WOOD_PRESSURE_PLATE);
		registerStrippable(ModBlocks.BIRCH_WOOD_WALL, ModBlocks.STR_BIRCH_WOOD_WALL);
		//birch
		registerStrippable(ModBlocks2.BIRCH_LOG_BUTTON, ModBlocks2.STR_BIRCH_LOG_BUTTON);
		registerStrippable(ModBlocks2.BIRCH_LOG_FENCE, ModBlocks2.STR_BIRCH_LOG_FENCE);
		registerStrippable(ModBlocks2.BIRCH_LOG_SLAB, ModBlocks2.STR_BIRCH_LOG_SLAB);
		registerStrippable(ModBlocks2.BIRCH_LOG_STAIRS, ModBlocks2.STR_BIRCH_LOG_STAIRS);
		registerStrippable(ModBlocks2.BIRCH_LOG_FENCE_GATE, ModBlocks2.STR_BIRCH_LOG_FENCE_GATE);
		registerStrippable(ModBlocks2.BIRCH_LOG_DOOR, ModBlocks2.STR_BIRCH_LOG_DOOR);
		registerStrippable(ModBlocks2.BIRCH_LOG_TRAPDOOR, ModBlocks2.STR_BIRCH_LOG_TRAPDOOR);
		registerStrippable(ModBlocks2.BIRCH_LOG_PRESSURE_PLATE, ModBlocks2.STR_BIRCH_LOG_PRESSURE_PLATE);
		registerStrippable(ModBlocks2.BIRCH_LOG_WALL, ModBlocks2.STR_BIRCH_LOG_WALL);
		//jungle
		registerStrippable(ModBlocks.JUNGLE_WOOD_BUTTON, ModBlocks.STR_JUNGLE_WOOD_BUTTON);
		registerStrippable(ModBlocks.JUNGLE_WOOD_FENCE, ModBlocks.STR_JUNGLE_WOOD_FENCE);
		registerStrippable(ModBlocks.JUNGLE_WOOD_SLAB, ModBlocks.STR_JUNGLE_WOOD_SLAB);
		registerStrippable(ModBlocks.JUNGLE_WOOD_STAIRS, ModBlocks.STR_JUNGLE_WOOD_STAIRS);
		registerStrippable(ModBlocks.JUNGLE_WOOD_FENCE_GATE, ModBlocks.STR_JUNGLE_WOOD_FENCE_GATE);
		registerStrippable(ModBlocks.JUNGLE_WOOD_DOOR, ModBlocks.STR_JUNGLE_WOOD_DOOR);
		registerStrippable(ModBlocks.JUNGLE_WOOD_TRAPDOOR, ModBlocks.STR_JUNGLE_WOOD_TRAPDOOR);
		registerStrippable(ModBlocks.JUNGLE_WOOD_PRESSURE_PLATE, ModBlocks.STR_JUNGLE_WOOD_PRESSURE_PLATE);
		registerStrippable(ModBlocks.JUNGLE_WOOD_WALL, ModBlocks.STR_JUNGLE_WOOD_WALL);
		//jungle
		registerStrippable(ModBlocks2.JUNGLE_LOG_BUTTON, ModBlocks2.STR_JUNGLE_LOG_BUTTON);
		registerStrippable(ModBlocks2.JUNGLE_LOG_FENCE, ModBlocks2.STR_JUNGLE_LOG_FENCE);
		registerStrippable(ModBlocks2.JUNGLE_LOG_SLAB, ModBlocks2.STR_JUNGLE_LOG_SLAB);
		registerStrippable(ModBlocks2.JUNGLE_LOG_STAIRS, ModBlocks2.STR_JUNGLE_LOG_STAIRS);
		registerStrippable(ModBlocks2.JUNGLE_LOG_FENCE_GATE, ModBlocks2.STR_JUNGLE_LOG_FENCE_GATE);
		registerStrippable(ModBlocks2.JUNGLE_LOG_DOOR, ModBlocks2.STR_JUNGLE_LOG_DOOR);
		registerStrippable(ModBlocks2.JUNGLE_LOG_TRAPDOOR, ModBlocks2.STR_JUNGLE_LOG_TRAPDOOR);
		registerStrippable(ModBlocks2.JUNGLE_LOG_PRESSURE_PLATE, ModBlocks2.STR_JUNGLE_LOG_PRESSURE_PLATE);
		registerStrippable(ModBlocks2.JUNGLE_LOG_WALL, ModBlocks2.STR_JUNGLE_LOG_WALL);
		//acacia
		registerStrippable(ModBlocks.ACACIA_WOOD_BUTTON, ModBlocks.STR_ACACIA_WOOD_BUTTON);
		registerStrippable(ModBlocks.ACACIA_WOOD_FENCE, ModBlocks.STR_ACACIA_WOOD_FENCE);
		registerStrippable(ModBlocks.ACACIA_WOOD_SLAB, ModBlocks.STR_ACACIA_WOOD_SLAB);
		registerStrippable(ModBlocks.ACACIA_WOOD_STAIRS, ModBlocks.STR_ACACIA_WOOD_STAIRS);
		registerStrippable(ModBlocks.ACACIA_WOOD_FENCE_GATE, ModBlocks.STR_ACACIA_WOOD_FENCE_GATE);
		registerStrippable(ModBlocks.ACACIA_WOOD_DOOR, ModBlocks.STR_ACACIA_WOOD_DOOR);
		registerStrippable(ModBlocks.ACACIA_WOOD_TRAPDOOR, ModBlocks.STR_ACACIA_WOOD_TRAPDOOR);
		registerStrippable(ModBlocks.ACACIA_WOOD_PRESSURE_PLATE, ModBlocks.STR_ACACIA_WOOD_PRESSURE_PLATE);
		registerStrippable(ModBlocks.ACACIA_WOOD_WALL, ModBlocks.STR_ACACIA_WOOD_WALL);
		//acacia
		registerStrippable(ModBlocks2.ACACIA_LOG_BUTTON, ModBlocks2.STR_ACACIA_LOG_BUTTON);
		registerStrippable(ModBlocks2.ACACIA_LOG_FENCE, ModBlocks2.STR_ACACIA_LOG_FENCE);
		registerStrippable(ModBlocks2.ACACIA_LOG_SLAB, ModBlocks2.STR_ACACIA_LOG_SLAB);
		registerStrippable(ModBlocks2.ACACIA_LOG_STAIRS, ModBlocks2.STR_ACACIA_LOG_STAIRS);
		registerStrippable(ModBlocks2.ACACIA_LOG_FENCE_GATE, ModBlocks2.STR_ACACIA_LOG_FENCE_GATE);
		registerStrippable(ModBlocks2.ACACIA_LOG_DOOR, ModBlocks2.STR_ACACIA_LOG_DOOR);
		registerStrippable(ModBlocks2.ACACIA_LOG_TRAPDOOR, ModBlocks2.STR_ACACIA_LOG_TRAPDOOR);
		registerStrippable(ModBlocks2.ACACIA_LOG_PRESSURE_PLATE, ModBlocks2.STR_ACACIA_LOG_PRESSURE_PLATE);
		registerStrippable(ModBlocks2.ACACIA_LOG_WALL, ModBlocks2.STR_ACACIA_LOG_WALL);
		//dark_oak
		registerStrippable(ModBlocks.DARK_OAK_WOOD_BUTTON, ModBlocks.STR_DARK_OAK_WOOD_BUTTON);
		registerStrippable(ModBlocks.DARK_OAK_WOOD_FENCE, ModBlocks.STR_DARK_OAK_WOOD_FENCE);
		registerStrippable(ModBlocks.DARK_OAK_WOOD_SLAB, ModBlocks.STR_DARK_OAK_WOOD_SLAB);
		registerStrippable(ModBlocks.DARK_OAK_WOOD_STAIRS, ModBlocks.STR_DARK_OAK_WOOD_STAIRS);
		registerStrippable(ModBlocks.DARK_OAK_WOOD_FENCE_GATE, ModBlocks.STR_DARK_OAK_WOOD_FENCE_GATE);
		registerStrippable(ModBlocks.DARK_OAK_WOOD_DOOR, ModBlocks.STR_DARK_OAK_WOOD_DOOR);
		registerStrippable(ModBlocks.DARK_OAK_WOOD_TRAPDOOR, ModBlocks.STR_DARK_OAK_WOOD_TRAPDOOR);
		registerStrippable(ModBlocks.DARK_OAK_WOOD_PRESSURE_PLATE, ModBlocks.STR_DARK_OAK_WOOD_PRESSURE_PLATE);
		registerStrippable(ModBlocks.DARK_OAK_WOOD_WALL, ModBlocks.STR_DARK_OAK_WOOD_WALL);
		//dark_oak
		registerStrippable(ModBlocks2.DARK_OAK_LOG_BUTTON, ModBlocks2.STR_DARK_OAK_LOG_BUTTON);
		registerStrippable(ModBlocks2.DARK_OAK_LOG_FENCE, ModBlocks2.STR_DARK_OAK_LOG_FENCE);
		registerStrippable(ModBlocks2.DARK_OAK_LOG_SLAB, ModBlocks2.STR_DARK_OAK_LOG_SLAB);
		registerStrippable(ModBlocks2.DARK_OAK_LOG_STAIRS, ModBlocks2.STR_DARK_OAK_LOG_STAIRS);
		registerStrippable(ModBlocks2.DARK_OAK_LOG_FENCE_GATE, ModBlocks2.STR_DARK_OAK_LOG_FENCE_GATE);
		registerStrippable(ModBlocks2.DARK_OAK_LOG_DOOR, ModBlocks2.STR_DARK_OAK_LOG_DOOR);
		registerStrippable(ModBlocks2.DARK_OAK_LOG_TRAPDOOR, ModBlocks2.STR_DARK_OAK_LOG_TRAPDOOR);
		registerStrippable(ModBlocks2.DARK_OAK_LOG_PRESSURE_PLATE, ModBlocks2.STR_DARK_OAK_LOG_PRESSURE_PLATE);
		registerStrippable(ModBlocks2.DARK_OAK_LOG_WALL, ModBlocks2.STR_DARK_OAK_LOG_WALL);
		//mangrove
		registerStrippable(ModBlocks.MANGROVE_WOOD_BUTTON, ModBlocks.STR_MANGROVE_WOOD_BUTTON);
		registerStrippable(ModBlocks.MANGROVE_WOOD_FENCE, ModBlocks.STR_MANGROVE_WOOD_FENCE);
		registerStrippable(ModBlocks.MANGROVE_WOOD_SLAB, ModBlocks.STR_MANGROVE_WOOD_SLAB);
		registerStrippable(ModBlocks.MANGROVE_WOOD_STAIRS, ModBlocks.STR_MANGROVE_WOOD_STAIRS);
		registerStrippable(ModBlocks.MANGROVE_WOOD_FENCE_GATE, ModBlocks.STR_MANGROVE_WOOD_FENCE_GATE);
		registerStrippable(ModBlocks.MANGROVE_WOOD_DOOR, ModBlocks.STR_MANGROVE_WOOD_DOOR);
		registerStrippable(ModBlocks.MANGROVE_WOOD_TRAPDOOR, ModBlocks.STR_MANGROVE_WOOD_TRAPDOOR);
		registerStrippable(ModBlocks.MANGROVE_WOOD_PRESSURE_PLATE, ModBlocks.STR_MANGROVE_WOOD_PRESSURE_PLATE);
		registerStrippable(ModBlocks.MANGROVE_WOOD_WALL, ModBlocks.STR_MANGROVE_WOOD_WALL);
		//mangrove
		registerStrippable(ModBlocks2.MANGROVE_LOG_BUTTON, ModBlocks2.STR_MANGROVE_LOG_BUTTON);
		registerStrippable(ModBlocks2.MANGROVE_LOG_FENCE, ModBlocks2.STR_MANGROVE_LOG_FENCE);
		registerStrippable(ModBlocks2.MANGROVE_LOG_SLAB, ModBlocks2.STR_MANGROVE_LOG_SLAB);
		registerStrippable(ModBlocks2.MANGROVE_LOG_STAIRS, ModBlocks2.STR_MANGROVE_LOG_STAIRS);
		registerStrippable(ModBlocks2.MANGROVE_LOG_FENCE_GATE, ModBlocks2.STR_MANGROVE_LOG_FENCE_GATE);
		registerStrippable(ModBlocks2.MANGROVE_LOG_DOOR, ModBlocks2.STR_MANGROVE_LOG_DOOR);
		registerStrippable(ModBlocks2.MANGROVE_LOG_TRAPDOOR, ModBlocks2.STR_MANGROVE_LOG_TRAPDOOR);
		registerStrippable(ModBlocks2.MANGROVE_LOG_PRESSURE_PLATE, ModBlocks2.STR_MANGROVE_LOG_PRESSURE_PLATE);
		registerStrippable(ModBlocks2.MANGROVE_LOG_WALL, ModBlocks2.STR_MANGROVE_LOG_WALL);
		//cherry
		registerStrippable(ModBlocks.CHERRY_WOOD_BUTTON, ModBlocks.STR_CHERRY_WOOD_BUTTON);
		registerStrippable(ModBlocks.CHERRY_WOOD_FENCE, ModBlocks.STR_CHERRY_WOOD_FENCE);
		registerStrippable(ModBlocks.CHERRY_WOOD_SLAB, ModBlocks.STR_CHERRY_WOOD_SLAB);
		registerStrippable(ModBlocks.CHERRY_WOOD_STAIRS, ModBlocks.STR_CHERRY_WOOD_STAIRS);
		registerStrippable(ModBlocks.CHERRY_WOOD_FENCE_GATE, ModBlocks.STR_CHERRY_WOOD_FENCE_GATE);
		registerStrippable(ModBlocks.CHERRY_WOOD_DOOR, ModBlocks.STR_CHERRY_WOOD_DOOR);
		registerStrippable(ModBlocks.CHERRY_WOOD_TRAPDOOR, ModBlocks.STR_CHERRY_WOOD_TRAPDOOR);
		registerStrippable(ModBlocks.CHERRY_WOOD_PRESSURE_PLATE, ModBlocks.STR_CHERRY_WOOD_PRESSURE_PLATE);
		registerStrippable(ModBlocks.CHERRY_WOOD_WALL, ModBlocks.STR_CHERRY_WOOD_WALL);
		//cherry
		registerStrippable(ModBlocks2.CHERRY_LOG_BUTTON, ModBlocks2.STR_CHERRY_LOG_BUTTON);
		registerStrippable(ModBlocks2.CHERRY_LOG_FENCE, ModBlocks2.STR_CHERRY_LOG_FENCE);
		registerStrippable(ModBlocks2.CHERRY_LOG_SLAB, ModBlocks2.STR_CHERRY_LOG_SLAB);
		registerStrippable(ModBlocks2.CHERRY_LOG_STAIRS, ModBlocks2.STR_CHERRY_LOG_STAIRS);
		registerStrippable(ModBlocks2.CHERRY_LOG_FENCE_GATE, ModBlocks2.STR_CHERRY_LOG_FENCE_GATE);
		registerStrippable(ModBlocks2.CHERRY_LOG_DOOR, ModBlocks2.STR_CHERRY_LOG_DOOR);
		registerStrippable(ModBlocks2.CHERRY_LOG_TRAPDOOR, ModBlocks2.STR_CHERRY_LOG_TRAPDOOR);
		registerStrippable(ModBlocks2.CHERRY_LOG_PRESSURE_PLATE, ModBlocks2.STR_CHERRY_LOG_PRESSURE_PLATE);
		registerStrippable(ModBlocks2.CHERRY_LOG_WALL, ModBlocks2.STR_CHERRY_LOG_WALL);
		//pale_oak
		registerStrippable(ModBlocks.PALE_OAK_WOOD_BUTTON, ModBlocks.STR_PALE_OAK_WOOD_BUTTON);
		registerStrippable(ModBlocks.PALE_OAK_WOOD_FENCE, ModBlocks.STR_PALE_OAK_WOOD_FENCE);
		registerStrippable(ModBlocks.PALE_OAK_WOOD_SLAB, ModBlocks.STR_PALE_OAK_WOOD_SLAB);
		registerStrippable(ModBlocks.PALE_OAK_WOOD_STAIRS, ModBlocks.STR_PALE_OAK_WOOD_STAIRS);
		registerStrippable(ModBlocks.PALE_OAK_WOOD_FENCE_GATE, ModBlocks.STR_PALE_OAK_WOOD_FENCE_GATE);
		registerStrippable(ModBlocks.PALE_OAK_WOOD_DOOR, ModBlocks.STR_PALE_OAK_WOOD_DOOR);
		registerStrippable(ModBlocks.PALE_OAK_WOOD_TRAPDOOR, ModBlocks.STR_PALE_OAK_WOOD_TRAPDOOR);
		registerStrippable(ModBlocks.PALE_OAK_WOOD_PRESSURE_PLATE, ModBlocks.STR_PALE_OAK_WOOD_PRESSURE_PLATE);
		registerStrippable(ModBlocks.PALE_OAK_WOOD_WALL, ModBlocks.STR_PALE_OAK_WOOD_WALL);
		//pale_oak
		registerStrippable(ModBlocks2.PALE_OAK_LOG_BUTTON, ModBlocks2.STR_PALE_OAK_LOG_BUTTON);
		registerStrippable(ModBlocks2.PALE_OAK_LOG_FENCE, ModBlocks2.STR_PALE_OAK_LOG_FENCE);
		registerStrippable(ModBlocks2.PALE_OAK_LOG_SLAB, ModBlocks2.STR_PALE_OAK_LOG_SLAB);
		registerStrippable(ModBlocks2.PALE_OAK_LOG_STAIRS, ModBlocks2.STR_PALE_OAK_LOG_STAIRS);
		registerStrippable(ModBlocks2.PALE_OAK_LOG_FENCE_GATE, ModBlocks2.STR_PALE_OAK_LOG_FENCE_GATE);
		registerStrippable(ModBlocks2.PALE_OAK_LOG_DOOR, ModBlocks2.STR_PALE_OAK_LOG_DOOR);
		registerStrippable(ModBlocks2.PALE_OAK_LOG_TRAPDOOR, ModBlocks2.STR_PALE_OAK_LOG_TRAPDOOR);
		registerStrippable(ModBlocks2.PALE_OAK_LOG_PRESSURE_PLATE, ModBlocks2.STR_PALE_OAK_LOG_PRESSURE_PLATE);
		registerStrippable(ModBlocks2.PALE_OAK_LOG_WALL, ModBlocks2.STR_PALE_OAK_LOG_WALL);
		//cherry
		registerStrippable(ModBlocks.BAMBOO_BLOCK_BUTTON, ModBlocks.STR_BAMBOO_BLOCK_BUTTON);
		registerStrippable(ModBlocks.BAMBOO_BLOCK_FENCE, ModBlocks.STR_BAMBOO_BLOCK_FENCE);
		registerStrippable(ModBlocks.BAMBOO_BLOCK_SLAB, ModBlocks.STR_BAMBOO_BLOCK_SLAB);
		registerStrippable(ModBlocks.BAMBOO_BLOCK_STAIRS, ModBlocks.STR_BAMBOO_BLOCK_STAIRS);
		registerStrippable(ModBlocks.BAMBOO_BLOCK_FENCE_GATE, ModBlocks.STR_BAMBOO_BLOCK_FENCE_GATE);
		registerStrippable(ModBlocks.BAMBOO_BLOCK_DOOR, ModBlocks.STR_BAMBOO_BLOCK_DOOR);
		registerStrippable(ModBlocks.BAMBOO_BLOCK_TRAPDOOR, ModBlocks.STR_BAMBOO_BLOCK_TRAPDOOR);
		registerStrippable(ModBlocks.BAMBOO_BLOCK_PRESSURE_PLATE, ModBlocks.STR_BAMBOO_BLOCK_PRESSURE_PLATE);
		registerStrippable(ModBlocks.BAMBOO_BLOCK_WALL, ModBlocks.STR_BAMBOO_BLOCK_WALL);
		//cherry
		registerStrippable(ModBlocks.CRIMSON_HYPHAE_BUTTON, ModBlocks.STR_CRIMSON_HYPHAE_BUTTON);
		registerStrippable(ModBlocks.CRIMSON_HYPHAE_FENCE, ModBlocks.STR_CRIMSON_HYPHAE_FENCE);
		registerStrippable(ModBlocks.CRIMSON_HYPHAE_SLAB, ModBlocks.STR_CRIMSON_HYPHAE_SLAB);
		registerStrippable(ModBlocks.CRIMSON_HYPHAE_STAIRS, ModBlocks.STR_CRIMSON_HYPHAE_STAIRS);
		registerStrippable(ModBlocks.CRIMSON_HYPHAE_FENCE_GATE, ModBlocks.STR_CRIMSON_HYPHAE_FENCE_GATE);
		registerStrippable(ModBlocks.CRIMSON_HYPHAE_DOOR, ModBlocks.STR_CRIMSON_HYPHAE_DOOR);
		registerStrippable(ModBlocks.CRIMSON_HYPHAE_TRAPDOOR, ModBlocks.STR_CRIMSON_HYPHAE_TRAPDOOR);
		registerStrippable(ModBlocks.CRIMSON_HYPHAE_PRESSURE_PLATE, ModBlocks.STR_CRIMSON_HYPHAE_PRESSURE_PLATE);
		registerStrippable(ModBlocks.CRIMSON_HYPHAE_WALL, ModBlocks.STR_CRIMSON_HYPHAE_WALL);
		//cherry
		registerStrippable(ModBlocks2.CRIMSON_STEM_BUTTON, ModBlocks2.STR_CRIMSON_STEM_BUTTON);
		registerStrippable(ModBlocks2.CRIMSON_STEM_FENCE, ModBlocks2.STR_CRIMSON_STEM_FENCE);
		registerStrippable(ModBlocks2.CRIMSON_STEM_SLAB, ModBlocks2.STR_CRIMSON_STEM_SLAB);
		registerStrippable(ModBlocks2.CRIMSON_STEM_STAIRS, ModBlocks2.STR_CRIMSON_STEM_STAIRS);
		registerStrippable(ModBlocks2.CRIMSON_STEM_FENCE_GATE, ModBlocks2.STR_CRIMSON_STEM_FENCE_GATE);
		registerStrippable(ModBlocks2.CRIMSON_STEM_DOOR, ModBlocks2.STR_CRIMSON_STEM_DOOR);
		registerStrippable(ModBlocks2.CRIMSON_STEM_TRAPDOOR, ModBlocks2.STR_CRIMSON_STEM_TRAPDOOR);
		registerStrippable(ModBlocks2.CRIMSON_STEM_PRESSURE_PLATE, ModBlocks2.STR_CRIMSON_STEM_PRESSURE_PLATE);
		registerStrippable(ModBlocks2.CRIMSON_STEM_WALL, ModBlocks2.STR_CRIMSON_STEM_WALL);
		//cherry
		registerStrippable(ModBlocks.WARPED_HYPHAE_BUTTON, ModBlocks.STR_WARPED_HYPHAE_BUTTON);
		registerStrippable(ModBlocks.WARPED_HYPHAE_FENCE, ModBlocks.STR_WARPED_HYPHAE_FENCE);
		registerStrippable(ModBlocks.WARPED_HYPHAE_SLAB, ModBlocks.STR_WARPED_HYPHAE_SLAB);
		registerStrippable(ModBlocks.WARPED_HYPHAE_STAIRS, ModBlocks.STR_WARPED_HYPHAE_STAIRS);
		registerStrippable(ModBlocks.WARPED_HYPHAE_FENCE_GATE, ModBlocks.STR_WARPED_HYPHAE_FENCE_GATE);
		registerStrippable(ModBlocks.WARPED_HYPHAE_DOOR, ModBlocks.STR_WARPED_HYPHAE_DOOR);
		registerStrippable(ModBlocks.WARPED_HYPHAE_TRAPDOOR, ModBlocks.STR_WARPED_HYPHAE_TRAPDOOR);
		registerStrippable(ModBlocks.WARPED_HYPHAE_PRESSURE_PLATE, ModBlocks.STR_WARPED_HYPHAE_PRESSURE_PLATE);
		registerStrippable(ModBlocks.WARPED_HYPHAE_WALL, ModBlocks.STR_WARPED_HYPHAE_WALL);
		//cherry
		registerStrippable(ModBlocks2.WARPED_STEM_BUTTON, ModBlocks2.STR_WARPED_STEM_BUTTON);
		registerStrippable(ModBlocks2.WARPED_STEM_FENCE, ModBlocks2.STR_WARPED_STEM_FENCE);
		registerStrippable(ModBlocks2.WARPED_STEM_SLAB, ModBlocks2.STR_WARPED_STEM_SLAB);
		registerStrippable(ModBlocks2.WARPED_STEM_STAIRS, ModBlocks2.STR_WARPED_STEM_STAIRS);
		registerStrippable(ModBlocks2.WARPED_STEM_FENCE_GATE, ModBlocks2.STR_WARPED_STEM_FENCE_GATE);
		registerStrippable(ModBlocks2.WARPED_STEM_DOOR, ModBlocks2.STR_WARPED_STEM_DOOR);
		registerStrippable(ModBlocks2.WARPED_STEM_TRAPDOOR, ModBlocks2.STR_WARPED_STEM_TRAPDOOR);
		registerStrippable(ModBlocks2.WARPED_STEM_PRESSURE_PLATE, ModBlocks2.STR_WARPED_STEM_PRESSURE_PLATE);
		registerStrippable(ModBlocks2.WARPED_STEM_WALL, ModBlocks2.STR_WARPED_STEM_WALL);
	}
}
